<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="BF12-1.aspx.cs" Inherits="NotaliaOnline.BF12_1" ValidateRequest="false" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" clientidmode="Static" id="div_input_form_1">
        <div class="card">
            <div class="card-header">
                ...
                Partage de biens de communauté ou de succession (art 748 CGI)
            </div>
    ...
    <script type="text/javascript" src="Scripts/BF12-1.js"></script>
</asp:Content>
