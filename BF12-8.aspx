<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="BF12-8.aspx.cs" Inherits="NotaliaOnline.BF12_8" ValidateRequest="false" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" clientidmode="Static" id="div_input_form_1">
        <div class="card">
            <div class="card-header">
                ...
                Licitation faisant cesser une indivision suite à divorce ou rupture de PACS
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="sub-card">
                    <div class="card-header">
                        Cession(s) de droits indivis anterieurs
                    </div>
                    <div class="card-body">
                        <div class="row form-group">
                            <label class="col-sm-4 col-12 col-form-label text-left text-sm-right"></label>
                            <asp:CheckBox runat="server" ClientIDMode="Static" ID="chk822" CssClass="checkbox col-sm-8 col-sm-offset-4 col-12"
                                Text="Présence de cession(s) de droits indivis antérieurs au profit du co-licitant ?" />
                        </div>
                        <div class="row form-group">
                            <label class="col-sm-4 col-12 col-form-label text-left text-sm-right">Montant des droits fiscaux payés :</label>
                            <div class="col-sm-3 col-12">
                                <asp:TextBox runat="server" ClientIDMode="Static" ID="txtZone824" CssClass="form-control control-input numberFormatFR"></asp:TextBox>
                                <i class="form-control-feedback fa fa-euro"></i>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript" src="Scripts/BF12-8.js"></script>
</asp:Content>
