...
{
    public partial class BF02_11 : Page
    {
        ...
        private bool FillValues(int id, int clientId)
        {
            try
            {
                ...
                var data = new JavaScriptSerializer().Deserialize<DataModelBF02_11>(obj.Value);
                txtDossier.Text = data.txtDossier;
                txtDateSignature.Text = data.txtDateDeSignature;
                txtRedacteur.Text = data.txtRedacteur;
                radMandat1.Checked = data.radMandat1.TransformToBoolean();
                radMandat2.Checked = data.radMandat2.TransformToBoolean();
                radMandat3.Checked = data.radMandat3.TransformToBoolean();
                radMandat4.Checked = data.radMandat4.TransformToBoolean();
                radMandat5.Checked = data.radMandat5.TransformToBoolean();
                txtValueMandat1.Text = data.txtValueMandat1;
                txtValueMandat2.Text = data.txtValueMandat2;
        ...
        private void SetRange()
        {
            ...
            _excelService.SetRange(_sessionId, "ENTREE_S",
                        new RangeCoordinates() { Row = 37, Column = 5, Height = 10, Width = 2 }, new object[]
                        {
                            new object[] {radMandat1.Checked.TransformToBooleanFr(), ""},
                            new object[] {radMandat2.Checked.TransformToBooleanFr(), ""},
                            new object[] {radMandat3.Checked.TransformToBooleanFr(), ""},
                            new object[] {radMandat4.Checked.TransformToBooleanFr(), ""},
                            new object[] {radMandat5.Checked.TransformToBooleanFr(), ""},
                            new object[] {txtValueMandat1.Text, ""},
                            new object[] {txtValueMandat2.Text, ""},
        ...
        private void SetValues(DataTable dt)
        {
            ...
            D523.InnerText = dt.Rows[21][(int)ColumnBF02_11.Col1].ToString();
            D524.InnerText = dt.Rows[22][(int)ColumnBF02_11.Col1].ToString();
            D525.InnerText = dt.Rows[23][(int)ColumnBF02_11.Col1].ToString();
            D526.InnerText = dt.Rows[24][(int)ColumnBF02_11.Col1].ToString();
            html += string.Format(
            ...
            html += string.Format("<div><br/><br/></div><div align='right'><img width='50%' src='{0}' id='msg' /></div>",
                Request.PhysicalApplicationPath + "tmp\\BF02-11\\chart.png");
            ...
            lblEmolumentTitle.InnerText = radMandat5.Checked
                ? "Emoluments du notaire - C.com. Art. A 444-80"
                : "Emoluments du notaire - C.com. Art. A 444-79 et A 444-79-1";
            ...
            D505.InnerText = dt.Rows[3][(int)ColumnBF02_11.Col1].ToString();
            //D507.InnerText = dt.Rows[5][(int)ColumnBF02_11.Col1].ToString();
            html += string.Format(
            ...
            html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
            D509.InnerText = dt.Rows[7][(int)ColumnBF02_11.Col1].ToString();
            D510.InnerText = dt.Rows[8][(int)ColumnBF02_11.Col1].ToString();
            D511.InnerText = dt.Rows[9][(int)ColumnBF02_11.Col1].ToString();
            D512.InnerText = dt.Rows[10][(int)ColumnBF02_11.Col1].ToString();
            D513.InnerText = dt.Rows[11][(int)ColumnBF02_11.Col1].ToString();
            html += string.Format(
            ...
            html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
            D517.InnerText = dt.Rows[15][(int)ColumnBF02_11.Col1].ToString();
            html += string.Format(
            ...
            D521.InnerText = dt.Rows[19][(int)ColumnBF02_11.Col1].ToString();
            html += string.Format(
                "<tr><td colspan='2' align='right'>Enregistrement :</td><td align='right'>{0}</td><td></td></tr>",
                D521.InnerText);
            html += "<tr><td colspan='4' align='center'>Acte dispensé de formalité (CGI art 680) - Paiement du droit sur état</td></tr>";
        ...
        protected void btnSynthese_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                watch = System.Diagnostics.Stopwatch.StartNew();
                var data = ExcelServiceHelper.GetRange(_excelService, _sessionId, "SORTIE_S", 501, 3, 25, 1, out _status);
                watch.Stop();
                elapsedMs = watch.ElapsedMilliseconds;
                ...
                CalculezMaintenantDataAccess.Save(Session["CLIENT_ID"].TransformToInt(), "BF02-11");
        ...
        protected void btnEnregistrer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var data = @"{" +
                           ...
                           "','radMandat1':'" + radMandat1.Checked + "','radMandat2':'" + radMandat2.Checked +
                           "','radMandat3':'" + radMandat3.Checked + "','radMandat4':'" + radMandat4.Checked +
                           "','radMandat5':'" + radMandat5.Checked +
                           "','txtValueMandat1':'" + txtValueMandat1.Text + "','txtValueMandat2':'" +
                           txtValueMandat2.Text +
                ...
                if (obj == null)
                {
                    SimulationActeDataAccess.Save(data, txtLibelle.Text, "BF02-11", false, Session["CLIENT_ID"].TransformToInt());
                }
                else
                {
        ...
        protected void btnEnregistrerSous_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var data = @"{" +
                           ...
                           "','txtDébours':'" + txtDébours.Text +
                           "','chkUtilisation_du_futur_tarif':'" + hdUtilisation_du_futur_tarif.Value + "'}";
                SimulationActeDataAccess.Save(data, txtLibelleSous.Text, "BF02-11", false, Session["CLIENT_ID"].TransformToInt());
                Page.ClientScript.RegisterStartupScript(GetType(), "toastr_message", @"toastr.success('Cette simulation a été enregistrée avec succès.', 'Notification', {timeOut: 5000});", true);
                Page.ClientScript.RegisterStartupScript(GetType(), "input_form_click", "ShowHide_input_form($('#btnSynthese'));", true);
            }
            catch (Exception)
        ...
        protected void btnSendEmail_Click(object sender, EventArgs e)
        {
            try
            {
                PdfHelper.GeneratePdf("BF02-11", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
        ...
        {
            var filename = PdfHelper.GeneratePdf("BF02-11", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
    ...
    class DataModelBF02_11
    {
        public string txtDossier { get; set; }
        public string txtDateDeSignature { get; set; }
        public string txtRedacteur { get; set; }
        public string radMandat1 { get; set; }
        public string radMandat2 { get; set; }
        public string radMandat3 { get; set; }
        public string radMandat4 { get; set; }
        public string radMandat5 { get; set; }
        public string txtValueMandat1 { get; set; }
        public string txtValueMandat2 { get; set; }
