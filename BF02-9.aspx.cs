...
{
    public partial class BF02_9 : Page
    {
        ...
        private bool FillValues(int id, int clientId)
        {
            try
            {
                ...
                var data = new JavaScriptSerializer().Deserialize<DataModelBF02_9>(obj.Value);
                txtDossier.Text = data.txtDossier;
                txtDateSignature.Text = data.txtDateDeSignature;
                txtRedacteur.Text = data.txtRedacteur;
                radDonationEntreEpoux1.Checked = data.radDonationEntreEpoux1.TransformToBoolean();
                radDonationEntreEpoux2.Checked = data.radDonationEntreEpoux2.TransformToBoolean();
                radDonationEntreEpoux3.Checked = data.radDonationEntreEpoux3.TransformToBoolean();
                radDonationEntreEpoux4.Checked = data.radDonationEntreEpoux4.TransformToBoolean();
        ...
        private void SetRange()
        {
            ...
            _excelService.SetRange(_sessionId, "ENTREE_S",
                        new RangeCoordinates() { Row = 31, Column = 5, Height = 6, Width = 2 }, new object[]
                        {
                            new object[] {radDonationEntreEpoux1.Checked.TransformToBooleanFr(), ""},
                            new object[] {radDonationEntreEpoux2.Checked.TransformToBooleanFr(), ""},
                            new object[] {radDonationEntreEpoux3.Checked.TransformToBooleanFr(), ""},
                            new object[] {radDonationEntreEpoux4.Checked.TransformToBooleanFr(), txtEmolument_de_formalités_HT.Text},
                            new object[] {txtNumPages.Text, txtDébours.Text},
                            new object[] {txtNumCopies.Text, hdUtilisation_du_futur_tarif.Value}
                        });
        }
        ...
        private void SetValues(DataTable dt)
        {
            ...
            D420.InnerText = dt.Rows[18][(int)ColumnBF02_9.Col1].ToString();
            D421.InnerText = dt.Rows[19][(int)ColumnBF02_9.Col1].ToString();
            D422.InnerText = dt.Rows[20][(int)ColumnBF02_9.Col1].ToString();
            D423.InnerText = dt.Rows[21][(int)ColumnBF02_9.Col1].ToString();
            ...
            html += string.Format("<div><br/><br/></div><div align='right'><img width='50%' src='{0}' id='msg' /></div>",
                Request.PhysicalApplicationPath + "tmp\\BF02-9\\chart.png");
            //DÉTAIL DES FRAIS
            html += "<table border-collapse='collapse' border='0' width='100%' size='1'>";
            ...
            html += "<tr><td bgcolor='#01ABE4' align='center' colspan='4'><b><font color='#FFFFFF' size='11px'>Emoluments du notaire - C.com. Art. A 444-69</font></b></td></tr>";
            html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
            D405.InnerText = dt.Rows[3][(int)ColumnBF02_9.Col1].ToString();
            //D407.InnerText = dt.Rows[5][(int)ColumnBF02_9.Col1].ToString();
            html += string.Format(
            ...
            html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
            D409.InnerText = dt.Rows[7][(int)ColumnBF02_9.Col1].ToString();
            D410.InnerText = dt.Rows[8][(int)ColumnBF02_9.Col1].ToString();
            D411.InnerText = dt.Rows[9][(int)ColumnBF02_9.Col1].ToString();
            D412.InnerText = dt.Rows[10][(int)ColumnBF02_9.Col1].ToString();
            D413.InnerText = dt.Rows[11][(int)ColumnBF02_9.Col1].ToString();
            html += string.Format(
            ...
            html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
            D417.InnerText = dt.Rows[15][(int)ColumnBF02_9.Col1].ToString();
            html += string.Format(
            ...
            html += "<tr><td colspan='4' align='center'>Acte enregistré lors du décès (CGI 635 1)</td></tr>";
        ...
        protected void btnSynthese_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                watch = System.Diagnostics.Stopwatch.StartNew();
                var data = ExcelServiceHelper.GetRange(_excelService, _sessionId, "SORTIE_S", 401, 3, 22, 1, out _status);
                watch.Stop();
                elapsedMs = watch.ElapsedMilliseconds;
                ...
                CalculezMaintenantDataAccess.Save(Session["CLIENT_ID"].TransformToInt(), "BF02-9");
        ...
        protected void btnEnregistrer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var data = @"{" +
                           ...
                           "','radDonationEntreEpoux1':'" + radDonationEntreEpoux1.Checked +
                           "','radDonationEntreEpoux2':'" + radDonationEntreEpoux2.Checked +
                           "','radDonationEntreEpoux3':'" + radDonationEntreEpoux3.Checked +
                           "','radDonationEntreEpoux4':'" + radDonationEntreEpoux4.Checked +
                ...
                if (obj == null)
                {
                    SimulationActeDataAccess.Save(data, txtLibelle.Text, "BF02-9", false, Session["CLIENT_ID"].TransformToInt());
                }
                else
                {
        ...
        protected void btnEnregistrerSous_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var data = @"{" +
                           ...
                           "','txtDébours':'" + txtDébours.Text +
                           "','chkUtilisation_du_futur_tarif':'" + hdUtilisation_du_futur_tarif.Value + "'}";
                SimulationActeDataAccess.Save(data, txtLibelleSous.Text, "BF02-9", false, Session["CLIENT_ID"].TransformToInt());
                Page.ClientScript.RegisterStartupScript(GetType(), "toastr_message", @"toastr.success('Cette simulation a été enregistrée avec succès.', 'Notification', {timeOut: 5000});", true);
                //BindSimulationList(0);
                //BindSimulationArchiveList(0);
                Page.ClientScript.RegisterStartupScript(GetType(), "input_form_click", "ShowHide_input_form($('#btnSynthese'));", true);
        ...
        protected void btnSendEmail_Click(object sender, EventArgs e)
        {
            try
            {
                PdfHelper.GeneratePdf("BF02-9", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
        ...
        {
            var filename = PdfHelper.GeneratePdf("BF02-9", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
    ...
    class DataModelBF02_9
    {
        public string txtDossier { get; set; }
        public string txtDateDeSignature { get; set; }
        public string txtRedacteur { get; set; }
        public string radDonationEntreEpoux1 { get; set; }
        public string radDonationEntreEpoux2 { get; set; }
        public string radDonationEntreEpoux3 { get; set; }
        public string radDonationEntreEpoux4 { get; set; }
