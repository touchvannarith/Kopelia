<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="BF02-2.aspx.cs" Inherits="NotaliaOnline.BF02_2" ValidateRequest="false" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="card">
            ...
            <div class="card-body text-right">
                <div class="row">
                    ...
                    <label runat="server" id="lblD125" clientidmode="Static" class="col-6 col-sm-3"></label>
                </div>
                <div class="row">
                    <label class="col-6 col-sm-6">Débours : </label>
                    <label runat="server" id="lblD126" clientidmode="Static" class="col-6 col-sm-3"></label>
                </div>
                <div class="row">
                    <label class="col-6 col-sm-6">Trésor public : </label>
                    <label runat="server" id="lblD127" clientidmode="Static" class="col-6 col-sm-3"></label>
                </div>
                <div class="row fa-2x">
                    <label class="col-6 col-sm-6">Montant des frais : </label>
                    <label runat="server" id="lblD128" class="col-6 col-sm-3"></label>
                </div>
            </div>
        </div>
        <div class="card">
            ...
            <div class="card-body">
                <div class="sub-card">
                    <div class="card-header">
                        Emoluments du notaire - C.com. Art. A 444-81
                    </div>
                    <div class="card-body text-right">
                        <div class="row ">
                            ...
                            <div class="col-6 col-sm-3">
                                <label runat="server" id="D104"></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="sub-card">
                    ...
                    <div class="card-body text-right">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-3">
                                <label runat="server" id="D111"></label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-sm-9">
                            ...
                            <div class="col-12 col-sm-3">
                                <label runat="server" id="D112"></label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-sm-9">
                            ...
                            <div class="col-12 col-sm-3">
                                <label runat="server" id="D113"></label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-sm-9">
                            ...
                            <div class="col-12 col-sm-3">
                                <label runat="server" id="D114"></label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-sm-9">
                            ...
                            <div class="col-12 col-sm-3">
                                <label runat="server" id="D115"></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="sub-card">
                    ...
                    <div class="card-body text-right">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-3">
                                <label runat="server" id="D119"></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="sub-card">
                    ...
                    <div class="card-body text-right">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-3">
                                <label runat="server" id="lblEnregistrement"></label>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="Scripts/BF02-2.js"></script>
</asp:Content>
