...
{
    public partial class BF12_10 : Page
    {
        ...
        private void SetValues(DataTable dt)
        {
            ...
            if (dt.Rows[6][(int)ColumnBF12.Col4].ToString() == show)
            {
                html += string.Format(
                        ...
                        Request.PhysicalApplicationPath + "tmp\\BF12-10\\chart.png");
            }
            else
            {
                html += string.Format(
            ...
            row155.Visible = dt.Rows[53][(int)ColumnBF12.Col4].ToString() == show;
            if (dt.Rows[53][(int)ColumnBF12.Col4].ToString() == show)
            {
                ...
                row156.Visible = dt.Rows[54][(int)ColumnBF12.Col4].ToString() == show;
                if (dt.Rows[54][(int)ColumnBF12.Col4].ToString() == show)
                {
                    F156.InnerText = dt.Rows[54][(int)ColumnBF12.Col1].ToString();
                    G156.InnerText = dt.Rows[54][(int)ColumnBF12.Col2].ToString();
                    H156.InnerText = dt.Rows[54][(int)ColumnBF12.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F156.InnerText, G156.InnerText, H156.InnerText);
                }
                row157.Visible = dt.Rows[55][(int)ColumnBF12.Col4].ToString() == show;
                if (dt.Rows[55][(int)ColumnBF12.Col4].ToString() == show)
                {
                    F157.InnerText = dt.Rows[55][(int)ColumnBF12.Col1].ToString();
                    G157.InnerText = dt.Rows[55][(int)ColumnBF12.Col2].ToString();
                    H157.InnerText = dt.Rows[55][(int)ColumnBF12.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F157.InnerText, G157.InnerText, H157.InnerText);
                }
                row158.Visible = dt.Rows[56][(int)ColumnBF12.Col4].ToString() == show;
                if (dt.Rows[56][(int)ColumnBF12.Col4].ToString() == show)
                {
                    F158.InnerText = dt.Rows[56][(int)ColumnBF12.Col1].ToString();
                    G158.InnerText = dt.Rows[56][(int)ColumnBF12.Col2].ToString();
                    H158.InnerText = dt.Rows[56][(int)ColumnBF12.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F158.InnerText, G158.InnerText, H158.InnerText);
                }
                row159.Visible = dt.Rows[57][(int)ColumnBF12.Col4].ToString() == show;
                if (dt.Rows[57][(int)ColumnBF12.Col4].ToString() == show)
                {
                    F159.InnerText = dt.Rows[57][(int)ColumnBF12.Col1].ToString();
                    G159.InnerText = dt.Rows[57][(int)ColumnBF12.Col2].ToString();
                    H159.InnerText = dt.Rows[57][(int)ColumnBF12.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F159.InnerText, G159.InnerText, H159.InnerText);
                }
                row161.Visible = dt.Rows[59][(int)ColumnBF12.Col4].ToString() == show;
                if (dt.Rows[59][(int)ColumnBF12.Col4].ToString() == show)
                {
                    G161.InnerText = dt.Rows[59][(int)ColumnBF12.Col2].ToString();
                    html += string.Format(
                        "<tr><td align='right'>Total :</td><td align='right'>{0}</td><td colspan='2'></td></tr>",
                        G161.InnerText);
                }
                row162.Visible = dt.Rows[60][(int)ColumnBF12.Col4].ToString() == show;
                if (dt.Rows[60][(int)ColumnBF12.Col4].ToString() == show)
                {
                    H162.InnerText = dt.Rows[60][(int)ColumnBF12.Col3].ToString();
                    html += string.Format(
                        "<tr><td colspan='2' align='right'>TOTAL Hors T.V.A :</td><td align='right'>{0}</td><td></td></tr>",
                        H162.InnerText);
                }
                row164.Visible = dt.Rows[62][(int)ColumnBF12.Col4].ToString() == show;
                if (dt.Rows[62][(int)ColumnBF12.Col4].ToString() == show)
                {
                    H164.InnerText = dt.Rows[62][(int)ColumnBF12.Col3].ToString();
                    html += string.Format(
        ...
        protected void btnSynthese_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CalculezMaintenantDataAccess.Save(Session["CLIENT_ID"].TransformToInt(), "BF12-10");
        ...
        protected void btnEnregistrer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (obj == null)
                {
                    SimulationActeDataAccess.Save(data, txtLibelle.Text, "BF12-10", false, Session["CLIENT_ID"].TransformToInt());
                }
                else
                {
        ...
        protected void btnEnregistrerSous_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var data = @"{" +
                    ...
                    "','chkUtilisation_du_futur_tarif':'" + hdUtilisation_du_futur_tarif.Value;
                data += "'}";
                SimulationActeDataAccess.Save(data, txtLibelleSous.Text, "BF12-10", false, Session["CLIENT_ID"].TransformToInt());
                Page.ClientScript.RegisterStartupScript(GetType(), "toastr_message", @"toastr.success('Cette simulation a été enregistrée avec succès.', 'Notification', {timeOut: 5000});", true);
                //BindSimulationList(0);
                //BindSimulationArchiveList(0);
                Page.ClientScript.RegisterStartupScript(GetType(), "input_form_click", "ShowHide_input_form($('#btnSynthese'));", true);
        ...
        protected void btnSendEmail_Click(object sender, EventArgs e)
        {
            try
            {
                PdfHelper.GeneratePdf("BF12-10", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
        ...
        {
            var filename = PdfHelper.GeneratePdf("BF12-10", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
