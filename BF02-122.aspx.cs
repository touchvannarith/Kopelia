...
{
    public partial class BF02_122 : Page
    {
        ...
        private bool FillValues(int id, int clientId)
        {
            try
            {
                ...
                txtNotoriété.Text = data.txtNotoriété;
        ...
        private void SetValues(DataTable dt)
        {
            ...
            D641.InnerText = dt.Rows[39][(int)ColumnBF02_122.Col1].ToString();
            D642.InnerText = dt.Rows[40][(int)ColumnBF02_122.Col1].ToString();
            D643.InnerText = dt.Rows[41][(int)ColumnBF02_122.Col1].ToString();
            D644.InnerText = dt.Rows[42][(int)ColumnBF02_122.Col1].ToString();
            html += string.Format(
            ...
            html += string.Format("<div><br/><br/></div><div align='right'><img width='50%' src='{0}' id='msg' /></div>",
                Request.PhysicalApplicationPath + "tmp\\BF02-122\\chart.png");
            //DÉTAIL DES FRAIS
            html += "<table border-collapse='collapse' border='0' width='100%' size='1'>";
            ...
            if (dt.Rows[5][(int)ColumnBF02_122.Col4].ToString() == show)
            {
                row607.Visible = true;
                lblRow11.InnerText = dt.Rows[5][(int)ColumnBF02_122.Col1].ToString();
                lblRow12.InnerText = dt.Rows[5][(int)ColumnBF02_122.Col2].ToString();
                lblRow13.InnerText = dt.Rows[5][(int)ColumnBF02_122.Col3].ToString();
                html += string.Format(
            ...
            if (dt.Rows[6][(int)ColumnBF02_122.Col4].ToString() == show)
            {
                row608.Visible = true;
                lblRow21.InnerText = dt.Rows[6][(int)ColumnBF02_122.Col1].ToString();
                lblRow22.InnerText = dt.Rows[6][(int)ColumnBF02_122.Col2].ToString();
                lblRow23.InnerText = dt.Rows[6][(int)ColumnBF02_122.Col3].ToString();
                html += string.Format(
                    "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                    lblRow21.InnerText, lblRow22.InnerText, lblRow23.InnerText);
            }
            row609.Visible = false;
            if (dt.Rows[7][(int)ColumnBF02_122.Col4].ToString() == show)
            {
                row609.Visible = true;
                lblRow31.InnerText = dt.Rows[7][(int)ColumnBF02_122.Col1].ToString();
                lblRow32.InnerText = dt.Rows[7][(int)ColumnBF02_122.Col2].ToString();
                lblRow33.InnerText = dt.Rows[7][(int)ColumnBF02_122.Col3].ToString();
                html += string.Format(
                    "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                    lblRow31.InnerText, lblRow32.InnerText, lblRow33.InnerText);
            }
            row610.Visible = false;
            if (dt.Rows[8][(int)ColumnBF02_122.Col4].ToString() == show)
            {
                row610.Visible = true;
                lblRow41.InnerText = dt.Rows[8][(int)ColumnBF02_122.Col1].ToString();
                lblRow42.InnerText = dt.Rows[8][(int)ColumnBF02_122.Col2].ToString();
                lblRow43.InnerText = dt.Rows[8][(int)ColumnBF02_122.Col3].ToString();
                html += string.Format(
                    "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                    lblRow41.InnerText, lblRow42.InnerText, lblRow43.InnerText);
            }
            row611.Visible = false;
            if (dt.Rows[9][(int)ColumnBF02_122.Col4].ToString() == show)
            {
                row611.Visible = true;
                lblTotal.InnerText = dt.Rows[9][(int)ColumnBF02_122.Col2].ToString();
                html += string.Format(
                    "<tr><td align='right'>Total :</td><td align='right'>{0}</td><td colspan='2'></td></tr>",
                    lblTotal.InnerText);
            }
            row613.Visible = false;
            if (dt.Rows[11][(int)ColumnBF02_122.Col1].ToString() == show)
            {
                row613.Visible = true;
                html += "<tr><td colspan='4' align='center'>Prise en compte de l'émolument minimum.</td></tr>";
            }
            D615.InnerText = dt.Rows[13][(int)ColumnBF02_122.Col1].ToString();
            html += string.Format(
            ...
            html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
            D619.InnerText = dt.Rows[17][(int)ColumnBF02_122.Col1].ToString();
            D620.InnerText = dt.Rows[18][(int)ColumnBF02_122.Col1].ToString();
            D621.InnerText = dt.Rows[19][(int)ColumnBF02_122.Col1].ToString();
            D622.InnerText = dt.Rows[20][(int)ColumnBF02_122.Col1].ToString();
            D623.InnerText = dt.Rows[21][(int)ColumnBF02_122.Col1].ToString();
            html += string.Format(
            ...
            html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
            D627.InnerText = dt.Rows[25][(int)ColumnBF02_122.Col1].ToString();
            html += string.Format(
            ...
            D631.InnerText = dt.Rows[29][(int)ColumnBF02_122.Col1].ToString();
            html += string.Format(
            ...
            if (dt.Rows[31][(int)ColumnBF02_122.Col4].ToString() == show)
            {
                row633.Visible = true;
                row635.Visible = false;
                if (dt.Rows[33][(int)ColumnBF02_122.Col4].ToString() == show)
                {
                    html += "<tr><td colspan='4' align='left'>Taxe de publicité :</td></tr>";
                    row635.Visible = true;
                    lblD627.InnerText = dt.Rows[33][(int)ColumnBF02_122.Col1].ToString();
                    lblE627.InnerText = dt.Rows[33][(int)ColumnBF02_122.Col2].ToString();
                    lblF627.InnerText = dt.Rows[33][(int)ColumnBF02_122.Col3].ToString();
                    html += string.Format(
                    ...
                    if (dt.Rows[34][(int)ColumnBF02_122.Col1].ToString() == show)
                    {
                        row636.Visible = true;
                ...
                if (dt.Rows[36][(int)ColumnBF02_122.Col4].ToString() == show)
                {
                    html += "<tr><td colspan='4' align='left'>CSI (art. 879 du CGI) :</td></tr>";
                    row638.Visible = true;
                    lblD630.InnerText = dt.Rows[36][(int)ColumnBF02_122.Col1].ToString();
                    lblE630.InnerText = dt.Rows[36][(int)ColumnBF02_122.Col2].ToString();
                    lblF630.InnerText = dt.Rows[36][(int)ColumnBF02_122.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td align='right'></td></tr>",
                        lblD630.InnerText, lblE630.InnerText, lblF630.InnerText);
                    row639.Visible = false;
                    if (dt.Rows[37][(int)ColumnBF02_122.Col1].ToString() == show)
                    {
                        row639.Visible = true;
                        html += "<tr><td colspan='4' align='center'>Prise en compte du minimum de perception.</td></tr>";
                    }
        ...
        protected void btnSynthese_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CalculezMaintenantDataAccess.Save(Session["CLIENT_ID"].TransformToInt(), "BF02-122");
        ...
        protected void btnEnregistrer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var data = @"{" +
                           ...
                           "','txtNotoriété':'" + txtNotoriété.Text +
                ...
                if (obj == null)
                {
                    SimulationActeDataAccess.Save(data, txtLibelle.Text, "BF02-122", false, Session["CLIENT_ID"].TransformToInt());
                }
                else
                {
        ...
        protected void btnEnregistrerSous_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var data = @"{" +
                           ...
                           "','txtDébours':'" + txtDébours.Text +
                           "','chkUtilisation_du_futur_tarif':'" + hdUtilisation_du_futur_tarif.Value + "'}";
                SimulationActeDataAccess.Save(data, txtLibelleSous.Text, "BF02-122", false, Session["CLIENT_ID"].TransformToInt());
                Page.ClientScript.RegisterStartupScript(GetType(), "toastr_message", @"toastr.success('Cette simulation a été enregistrée avec succès.', 'Notification', {timeOut: 5000});", true);
                //BindSimulationList(0);
                //BindSimulationArchiveList(0);
                Page.ClientScript.RegisterStartupScript(GetType(), "input_form_click", "ShowHide_input_form($('#btnSynthese'));", true);
        ...
        protected void btnSendEmail_Click(object sender, EventArgs e)
        {
            try
            {
                PdfHelper.GeneratePdf("BF02-122", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
        ...
        {
            var filename = PdfHelper.GeneratePdf("BF02-122", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
