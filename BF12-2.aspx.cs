...
{
    public partial class BF12_2 : Page
    {
        ...
        private bool FillValues(int id, int clientId)
        {
            try
            {
                ...
                txtRedacteur.Text = json["txtRedacteur"].ToString();
                    ...
                    chk76.Checked = json["chk76"].TransformToBoolean();
                    chk78.Checked = json["chk78"].TransformToBoolean();
        ...
        private void SetRange()
        {
            ...
            _excelService.SetRange(_sessionId, "ENTREE_S",
                    new RangeCoordinates { Row = 51, Column = 5, Height = 2, Width = 1 },
                    new object[]
                    {
                        new object[]{chk76.Checked.TransformToBooleanFr()},
                        new object[]{chk78.Checked.TransformToBooleanFr()}
                    });
            _excelService.SetRange(_sessionId, "ENTREE_S",
        ...
        private void SetValues(DataTable dt)
        {
            ...
            div114.Visible = dt.Rows[12][(int)ColumnBF12.Col4].ToString() == show;
            lblF114.InnerText = dt.Rows[12][(int)ColumnBF12.Col1].ToString();
            lblG114.InnerText = dt.Rows[12][(int)ColumnBF12.Col2].ToString();
            lblH114.InnerText = dt.Rows[12][(int)ColumnBF12.Col3].ToString();
            div115.Visible = dt.Rows[13][(int)ColumnBF12.Col4].ToString() == show;
            lblF115.InnerText = dt.Rows[13][(int)ColumnBF12.Col1].ToString();
            lblG115.InnerText = dt.Rows[13][(int)ColumnBF12.Col2].ToString();
            lblH115.InnerText = dt.Rows[13][(int)ColumnBF12.Col3].ToString();
            div116.Visible = dt.Rows[14][(int)ColumnBF12.Col4].ToString() == show;
            lblF116.InnerText = dt.Rows[14][(int)ColumnBF12.Col1].ToString();
            lblG116.InnerText = dt.Rows[14][(int)ColumnBF12.Col2].ToString();
            lblH116.InnerText = dt.Rows[14][(int)ColumnBF12.Col3].ToString();
            div117.Visible = dt.Rows[15][(int)ColumnBF12.Col4].ToString() == show;
            lblF117.InnerText = dt.Rows[15][(int)ColumnBF12.Col1].ToString();
            lblG117.InnerText = dt.Rows[15][(int)ColumnBF12.Col2].ToString();
            lblH117.InnerText = dt.Rows[15][(int)ColumnBF12.Col3].ToString();
            div119.Visible = dt.Rows[17][(int)ColumnBF12.Col4].ToString() == show;
            lblG119.InnerText = dt.Rows[17][(int)ColumnBF12.Col2].ToString();
            div120.Visible = dt.Rows[18][(int)ColumnBF12.Col4].ToString() == show;
            lblH120.InnerText = dt.Rows[18][(int)ColumnBF12.Col3].ToString();
            div122.Visible = dt.Rows[20][(int)ColumnBF12.Col4].ToString() == show;
            lblH122.InnerText = dt.Rows[20][(int)ColumnBF12.Col3].ToString();
            //TVA
            ...
            if (dt.Rows[6][(int)ColumnBF12.Col4].ToString() == show)
            {
                html += string.Format(
                        ...
                        Request.PhysicalApplicationPath + "tmp\\BF12-2\\chart.png");
            }
            else
            {
                html += string.Format(
            ...
            //Emoluments du notaire - C.com. Art. A 444-121
            row113.Visible = dt.Rows[11][(int)ColumnBF12.Col4].ToString() == show;
            if (dt.Rows[11][(int)ColumnBF12.Col4].ToString() == show)
            {
                html += "<tr><td bgcolor='#01ABE4' valign='middle' align='center' colspan='4'><b><font color='#FFFFFF' size='11px'>Emoluments du notaire - C.com. Art. A 444-121</font></b></td></tr>";
                html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
                if (dt.Rows[12][(int)ColumnBF12.Col4].ToString() == show)
                {
                    html += string.Format(
                ...
                if (dt.Rows[13][(int)ColumnBF12.Col4].ToString() == show)
                {
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        lblF115.InnerText, lblG115.InnerText, lblH115.InnerText);
                }
                if (dt.Rows[14][(int)ColumnBF12.Col4].ToString() == show)
                {
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        lblF116.InnerText, lblG116.InnerText, lblH116.InnerText);
                }
                if (dt.Rows[15][(int)ColumnBF12.Col4].ToString() == show)
                {
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        lblF117.InnerText, lblG117.InnerText, lblH117.InnerText);
                }
                if (dt.Rows[17][(int)ColumnBF12.Col4].ToString() == show)
                {
                    html += string.Format(
                        "<tr><td align='right'>Total :</td><td align='right'>{0}</td><td colspan='2'></td></tr>",
                        lblG119.InnerText);
                }
                if (dt.Rows[18][(int)ColumnBF12.Col4].ToString() == show)
                {
                    html += string.Format(
                        "<tr><td colspan='2' align='right'>TOTAL Hors T.V.A :</td><td align='right'>{0}</td><td></td></tr>",
                        lblH120.InnerText);
                }
                if (dt.Rows[20][(int)ColumnBF12.Col4].ToString() == show)
                {
                    html += string.Format(
        ...
        protected void btnSynthese_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CalculezMaintenantDataAccess.Save(Session["CLIENT_ID"].TransformToInt(), "BF12-2");
        ...
        protected void btnEnregistrer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (obj == null)
                {
                    SimulationActeDataAccess.Save(data, txtLibelle.Text, "BF12-2", false, Session["CLIENT_ID"].TransformToInt());
                }
                else
                {
        ...
        protected void btnEnregistrerSous_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var data = @"{" +
                    ...
                    "','chkUtilisation_du_futur_tarif':'" + hdUtilisation_du_futur_tarif.Value;
                data += "'}";
                SimulationActeDataAccess.Save(data, txtLibelleSous.Text, "BF12-2", false, Session["CLIENT_ID"].TransformToInt());
                Page.ClientScript.RegisterStartupScript(GetType(), "toastr_message", @"toastr.success('Cette simulation a été enregistrée avec succès.', 'Notification', {timeOut: 5000});", true);
                //BindSimulationList(0);
                //BindSimulationArchiveList(0);
                Page.ClientScript.RegisterStartupScript(GetType(), "input_form_click", "ShowHide_input_form($('#btnSynthese'));", true);
        ...
        protected void btnSendEmail_Click(object sender, EventArgs e)
        {
            try
            {
                PdfHelper.GeneratePdf("BF12-2", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
        ...
        {
            var filename = PdfHelper.GeneratePdf("BF12-2", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
