function SetDefaultValues() {
    var emolument = 800.00, debours = 200.00;
...
function htmlReport() {
    ...
    html += "<tr><td colspan='4' bgcolor='#304F73' align='center'><b><font color='#FFFFFF' size='11px'>Notoriété prescription acquisitive</font></b></td></tr>";
    ...
    html += "<tr><td colspan='4' bgcolor='#304F73'></td></tr>";
    html += "<tr>";
    html += "<td width='40%' align='right' colspan='2'>Valeur du bien prescrit :</td>";
    html += "<td width='100%' align='right'>" + $("#txtNotoriété").val() + " €</td>";
    html += "<tr><td colspan='4'></td></tr>";
    html += "</tr>";
    html += "<tr><td colspan='4'></td></tr>";
