...
function htmlReport() {
    ...
    html += "<tr><td colspan='4' bgcolor='#304F73' align='center'><b><font color='#FFFFFF' size='11px'>Licitation faisant cesser une indivision familiale</font></b></td></tr>";
    ...
    //Cession(s) de droits indivis anterieurs
        ...
        html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
        html += "<tr>";
        html += "<td align='right' colspan='2'>Présence de cession(s) de droits indivis antérieurs au profit du co-licitant ?</td><td align='right'>" + ($('#chk822').is(':checked') ? "OUI" : "NON") + "</td><td></td>";
    html += "</tr>";
