...
$("#chk822").change(function () {
    if ($(this).is(":checked")) {
        ShowElements([$("#txtZone824")], "div.row");
    } else {
        HideElements([$("#txtZone824")], "div.row");
    }
}).change();
...
function htmlReport() {
    ...
    html += "<tr><td colspan='4' bgcolor='#304F73' align='center'><b><font color='#FFFFFF' size='11px'>Licitation faisant cesser une indivision suite à divorce ou rupture de PACS</font></b></td></tr>";
    ...
    //Cession(s) de droits indivis anterieurs
        html += "<tr><td colspan='4' bgcolor='#01ABE4' align='center'><b><font color='#FFFFFF' size='11px'>Cession(s) de droits indivis anterieurs</font></b></td></tr>";
        html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
        html += "<tr>";
        html += "<td align='right' colspan='2'>Présence de cession(s) de droits indivis antérieurs au profit du co-licitant ?</td><td align='right'>" + ($('#chk822').is(':checked') === true ? "OUI" : "NON") + "</td><td></td>";
    html += "</tr>";
    if ($("#txtZone824").css('display') !== none) {
        html += "<tr>";
        html += "<td align='right' colspan='2'>Montant des droits fiscaux payés :</td>";
        html += "<td align='right'>" + $("#txtZone824").val() + " €</td><td></td>";
        html += "</tr>";
    }
        html += "<tr><td colspan='4'></td></tr>";
