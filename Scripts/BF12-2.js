...
function htmlReport() {
    ...
    html += "<tr><td colspan='4' bgcolor='#304F73' align='center'><b><font color='#FFFFFF' size='11px'>Partage de biens de communauté consécutif à divorce (art 746 CGI)</font></b></td></tr>";
    ...
    html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
    html += "<tr>";
    html += "<td align='right' colspan='2'>Notaire commis en cas de divorce (C. civ., art.255, 10°) ?</td><td align='right'>" + ($('#chk76').is(':checked') === true ? "OUI" : "NON") + "</td><td></td>";
    html += "</tr>";
    html += "<tr>";
    html += "<td align='right' colspan='2'>Application de l'aide juridictionnelle ?</td><td align='right'>" + ($('#chk78').is(':checked') === true ? "OUI" : "NON") + "</td><td></td>";
    html += "</tr>";
    html += "<tr><td colspan='4'></td></tr>";
    //Biens immobiliers
