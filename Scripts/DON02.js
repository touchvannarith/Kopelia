...
$('#txtZone02, #txtZone03').datetimepicker({
    locale: 'fr',
    format: 'L',
...
var $chk1 = $("#chk1"), $txtZone01 = $("#txtZone01"), $txtZone02 = $("#txtZone02"), $txtZone03 = $("#txtZone03");
...
function ShowHideElements(element) {
    ...
    for (var j = 10; j > parseInt($("#ddl1").val()); j--) {
...
function htmlReport() {
    ...
    html += "<tr><td colspan='4' bgcolor='#304F73' align='center'><b><font color='#FFFFFF' size='11px'>Donation et donation partage (2 donateurs)</font></b></td></tr>";
    ...
    if ($txtZone02.css("display") !== none) {
        html += "<tr>";
        html += "<td align='right' colspan='2'>Date de naissance du donateur 1 :</td>";
        html += "<td align='right'>" + $txtZone02.val() + "</td><td></td>";
        html += "</tr>";
    }
    if ($txtZone03.css("display") !== none) {
        html += "<tr>";
        html += "<td align='right' colspan='2'>Date de naissance du donateur 2 :</td>";
    ...
    for (var i = 1; i <= parseInt($("#ddl1").val()); i++) {
        ...
        html += "<tr>";
        html += "<td align='right'>Origine :</td><td align='right'>" + $('#ddlOrigine' + i + ' option:selected').text() + "</td>";
