...
var $txtZone01 = $("#txtZone01"), $txtZone02 = $("#txtZone02"), $txtZone03 = $("#txtZone03"), $txtZone04 = $("#txtZone04"), $txtZone05 = $("#txtZone05"),
    $txtZone06 = $("#txtZone06"), $txtZone07 = $("#txtZone07");
...
function ShowHideElements() {
    ...
    if ("124".indexOf($ddl1.val()) !== -1) {
        ShowElements([$chk3], "div.row");
        ...
        HideElements([$chk3, $txtZone06], "div.row");
    }

    if ("23".indexOf($ddl1.val()) !== -1) {
        ShowElements([$chk4], "div.row");
        if ($chk1.is(":checked") && $chk4.is(":checked")) {
            ShowElements([$txtZone07], "div.row");
        } else {
            HideElements([$txtZone07], "div.row");
        }
    } else {
        HideElements([$chk4, $txtZone07], "div.row");
    }
}
...
function htmlReport() {
    ...
    html += "<tr><td colspan='4' bgcolor='#304F73' align='center'><b><font color='#FFFFFF' size='11px'>DONATION - Droits de mutation à titre gratuit</font></b></td></tr>";
    ...
    html += "<tr><td bgcolor='#01ABE4' valign='middle' align='center' colspan='4'><b><font color='#FFFFFF' size='11px'>Détermination de la parenté Donateur/Donataire</font></b></td></tr>";
    html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
    html += "<tr>";
    ...
    html += "</tr>";
    html += "<tr>";
    html += "<td align='right' colspan='2'>Base taxable hors exonération :</td>";
    ...
    if ($("#TextBox3").css("display") !== none) {
        html += "<tr>";
        html += "<td align='right' colspan='2'>Abattement spécifique pour somme d'argent :</td>";
        html += "<td align='right'>Cocher si Oui : " + ($chk3.is(":checked") ? "Oui" : "Non") + "</td><td align='right'></td>";
        html += "</tr>";
    }
    if ($txtZone06.css("display") !== none) {
        html += "<tr>";
        html += "<td align='right' colspan='2'>Abattement (790 A bis) utilisé :</td>";
        html += "<td align='right'>" + $txtZone06.val() + " €</td><td></td>";
        html += "</tr>";
    }
    if ($("#TextBox4").css("display") !== none) {
        html += "<tr>";
        html += "<td align='right' colspan='2'>Abattement descendant au 2éme degré :</td>";
        html += "<td align='right'>Cocher si Oui : " + ($chk4.is(":checked") ? "Oui" : "Non") + "</td><td align='right'></td>";
        html += "</tr>";
    }
    if ($txtZone07.css("display") !== none) {
        html += "<tr>";
        html += "<td align='right' colspan='2'>Abattement (790 B) utilisé :</td>";
