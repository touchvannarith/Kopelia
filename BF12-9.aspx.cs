...
{
    public partial class BF12_9 : Page
    {
        ...
        private bool FillValues(int id, int clientId)
        {
            try
            {
                ...
                txtRedacteur.Text = json["txtRedacteur"].ToString();
                    ...
                    txtZone864.Text = json["txtZone864"].ToString();
                    txtZone866.Text = json["txtZone866"].ToString();
                    txtZone871.Text = json["txtZone871"].ToString();
        ...
        private void SetRange()
        {
            _excelService.SetRange(_sessionId, "ENTREE_S",
                new RangeCoordinates { Row = 5, Column = 4, Height = 4, Width = 1 },
                new object[]
                {
                        new object[] {"9"},
            ...
            _excelService.SetRange(_sessionId, "ENTREE_S",
                new RangeCoordinates { Row = 61, Column = 5, Height = 10, Width = 1 },
                new object[]
                {
                        new object[]{txtZone864.Text},
                        new object[]{txtZone866.Text},
                        new object[]{txtZone871.Text},
                        new object[]{null},
                        new object[]{null},
        ...
        {
            const string show = "1";
            lblF102.InnerText = dt.Rows[0][(int)ColumnBF12_9.Col1].ToString();
            lblF103.InnerText = dt.Rows[1][(int)ColumnBF12_9.Col1].ToString();
            lblF104.InnerText = dt.Rows[2][(int)ColumnBF12_9.Col1].ToString();
            lblF106.InnerText = dt.Rows[4][(int)ColumnBF12_9.Col1].ToString();
            //TVA
            H171.InnerText = dt.Rows[69][(int)ColumnBF12_9.Col3].ToString();
            H173.InnerText = dt.Rows[71][(int)ColumnBF12_9.Col3].ToString();
            H175.InnerText = dt.Rows[73][(int)ColumnBF12_9.Col3].ToString();
            H176.InnerText = dt.Rows[74][(int)ColumnBF12_9.Col3].ToString();
            H177.InnerText = dt.Rows[75][(int)ColumnBF12_9.Col3].ToString();
            //Débours
            lblH182.InnerText = dt.Rows[80][(int)ColumnBF12_9.Col3].ToString();
            //Trésor public
            div187.Visible = dt.Rows[85][(int)ColumnBF12_9.Col4].ToString() == show;
            div188.Visible = dt.Rows[86][(int)ColumnBF12_9.Col4].ToString() == show;
            lblF188.InnerText = dt.Rows[86][(int)ColumnBF12_9.Col1].ToString();
            lblG188.InnerText = dt.Rows[86][(int)ColumnBF12_9.Col2].ToString();
            lblH188.InnerText = dt.Rows[86][(int)ColumnBF12_9.Col3].ToString();
            lblF189.Visible = dt.Rows[87][(int)ColumnBF12_9.Col4].ToString() == show;
            lblF189.InnerText = dt.Rows[87][(int)ColumnBF12_9.Col1].ToString();
            div190.Visible = dt.Rows[88][(int)ColumnBF12_9.Col4].ToString() == show;
            ...
            html += dt.Rows[6][(int)ColumnBF12_9.Col4].ToString() == show
            ...
            html += string.Format(
                    ...
                    lblF106.InnerText);
            html += "</table>";
            if (dt.Rows[6][(int)ColumnBF12_9.Col4].ToString() == show)
            {
                html += string.Format(
                        "<div align='right'><img width='50%' src='{0}' id='msg' /></div>",
                        Request.PhysicalApplicationPath + "tmp\\BF12-9\\chart.png");
            }
            else
            {
                html += string.Format(
            ...
            row141.Visible = dt.Rows[39][(int)ColumnBF12_9.Col4].ToString() == show;
            if (dt.Rows[39][(int)ColumnBF12_9.Col4].ToString() == show)
            {
                html += "<tr><td bgcolor='#01ABE4' valign='middle' align='center' colspan='4'><b><font color='#FFFFFF' size='11px'>Emoluments du notaire - C.com. Art. A 444-87a</font></b></td></tr>";
                html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
                row142.Visible = dt.Rows[40][(int)ColumnBF12_9.Col4].ToString() == show;
                if (dt.Rows[40][(int)ColumnBF12_9.Col4].ToString() == show)
                {
                    F142.InnerText = dt.Rows[40][(int)ColumnBF12_9.Col1].ToString();
                    G142.InnerText = dt.Rows[40][(int)ColumnBF12_9.Col2].ToString();
                    H142.InnerText = dt.Rows[40][(int)ColumnBF12_9.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F142.InnerText, G142.InnerText, H142.InnerText);
                }
                row143.Visible = dt.Rows[41][(int)ColumnBF12_9.Col4].ToString() == show;
                if (dt.Rows[41][(int)ColumnBF12_9.Col4].ToString() == show)
                {
                    F143.InnerText = dt.Rows[41][(int)ColumnBF12_9.Col1].ToString();
                    G143.InnerText = dt.Rows[41][(int)ColumnBF12_9.Col2].ToString();
                    H143.InnerText = dt.Rows[41][(int)ColumnBF12_9.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F143.InnerText, G143.InnerText, H143.InnerText);
                }
                row144.Visible = dt.Rows[42][(int)ColumnBF12_9.Col4].ToString() == show;
                if (dt.Rows[42][(int)ColumnBF12_9.Col4].ToString() == show)
                {
                    F144.InnerText = dt.Rows[42][(int)ColumnBF12_9.Col1].ToString();
                    G144.InnerText = dt.Rows[42][(int)ColumnBF12_9.Col2].ToString();
                    H144.InnerText = dt.Rows[42][(int)ColumnBF12_9.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F144.InnerText, G144.InnerText, H144.InnerText);
                }
                row145.Visible = dt.Rows[43][(int)ColumnBF12_9.Col4].ToString() == show;
                if (dt.Rows[43][(int)ColumnBF12_9.Col4].ToString() == show)
                {
                    F145.InnerText = dt.Rows[43][(int)ColumnBF12_9.Col1].ToString();
                    G145.InnerText = dt.Rows[43][(int)ColumnBF12_9.Col2].ToString();
                    H145.InnerText = dt.Rows[43][(int)ColumnBF12_9.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F145.InnerText, G145.InnerText, H145.InnerText);
                }
                row147.Visible = dt.Rows[45][(int)ColumnBF12_9.Col4].ToString() == show;
                if (dt.Rows[45][(int)ColumnBF12_9.Col4].ToString() == show)
                {
                    G147.InnerText = dt.Rows[45][(int)ColumnBF12_9.Col2].ToString();
                    html += string.Format(
                        "<tr><td align='right'>Total :</td><td align='right'>{0}</td><td colspan='2'></td></tr>",
                        G147.InnerText);
                }
                row148.Visible = dt.Rows[46][(int)ColumnBF12_9.Col4].ToString() == show;
                if (dt.Rows[46][(int)ColumnBF12_9.Col4].ToString() == show)
                {
                    H148.InnerText = dt.Rows[46][(int)ColumnBF12_9.Col3].ToString();
                    html += string.Format(
                        "<tr><td colspan='2' align='right'>TOTAL Hors T.V.A :</td><td align='right'>{0}</td><td></td></tr>",
                        H148.InnerText);
                }
                row150.Visible = dt.Rows[48][(int)ColumnBF12_9.Col4].ToString() == show;
                if (dt.Rows[48][(int)ColumnBF12_9.Col4].ToString() == show)
                {
                    H150.InnerText = dt.Rows[48][(int)ColumnBF12_9.Col3].ToString();
                    html += string.Format(
            ...
            html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
            if (dt.Rows[85][(int)ColumnBF12_9.Col4].ToString() == show)
            {
                if (dt.Rows[86][(int)ColumnBF12_9.Col4].ToString() == show)
                {
                    html += string.Format(
                ...
                if (dt.Rows[87][(int)ColumnBF12_9.Col4].ToString() == show)
                {
                    html += string.Format("<tr><td colspan='4' align='center'>{0}</td></tr>", lblF189.InnerText);
                }
                if (dt.Rows[88][(int)ColumnBF12_9.Col4].ToString() == show)
                {
                    html += "<tr><td colspan='4' align='center'>Pour la TPF, il a été pris le minimum de perception soit 25 Euros.</td></tr>";
                }
            }
            row192.Visible = dt.Rows[90][(int)ColumnBF12_9.Col4].ToString() == show;
            if (dt.Rows[90][(int)ColumnBF12_9.Col4].ToString() == show)
            {
                H192.InnerText = dt.Rows[90][(int)ColumnBF12_9.Col3].ToString();
                H193.InnerText = dt.Rows[91][(int)ColumnBF12_9.Col3].ToString();
                html += string.Format(
            ...
            row195.Visible = dt.Rows[93][(int)ColumnBF12_9.Col4].ToString() == show;
            if (dt.Rows[93][(int)ColumnBF12_9.Col4].ToString() == show)
            {
                row196.Visible = dt.Rows[94][(int)ColumnBF12_9.Col4].ToString() == show;
                if (dt.Rows[94][(int)ColumnBF12_9.Col4].ToString() == show)
                {
                    F196.InnerText = dt.Rows[94][(int)ColumnBF12_9.Col1].ToString();
                    G196.InnerText = dt.Rows[94][(int)ColumnBF12_9.Col2].ToString();
                    H196.InnerText = dt.Rows[94][(int)ColumnBF12_9.Col3].ToString();
                    html += string.Format(
                ...
                row197.Visible = dt.Rows[95][(int)ColumnBF12_9.Col4].ToString() == show;
                if (dt.Rows[95][(int)ColumnBF12_9.Col4].ToString() == show)
                {
            ...
            row199.Visible = dt.Rows[97][(int)ColumnBF12_9.Col4].ToString() == show;
            if (dt.Rows[97][(int)ColumnBF12_9.Col4].ToString() == show)
            {
                html += "<tr><td colspan='4' align='left'>Droit de mutation sur le prix de cession :</td></tr>";
                row200.Visible = dt.Rows[98][(int)ColumnBF12_9.Col4].ToString() == show;
                if (dt.Rows[98][(int)ColumnBF12_9.Col4].ToString() == show)
                {
                    F200.InnerText = dt.Rows[98][(int)ColumnBF12_9.Col1].ToString();
                    G200.InnerText = dt.Rows[98][(int)ColumnBF12_9.Col2].ToString();
                    H200.InnerText = dt.Rows[98][(int)ColumnBF12_9.Col3].ToString();
                    html += string.Format(
                        "<tr><td></td><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td></tr>",
                        F200.InnerText, G200.InnerText, H200.InnerText);
                }
                row201.Visible = dt.Rows[99][(int)ColumnBF12_9.Col4].ToString() == show;
                if (dt.Rows[99][(int)ColumnBF12_9.Col4].ToString() == show)
                {
                    F201.InnerText = dt.Rows[99][(int)ColumnBF12_9.Col1].ToString();
                    G201.InnerText = dt.Rows[99][(int)ColumnBF12_9.Col2].ToString();
                    H201.InnerText = dt.Rows[99][(int)ColumnBF12_9.Col3].ToString();
                    html += string.Format(
                        "<tr><td></td><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td></tr>",
                        F201.InnerText, G201.InnerText, H201.InnerText);
                }
                row202.Visible = dt.Rows[100][(int)ColumnBF12_9.Col4].ToString() == show;
                if (dt.Rows[100][(int)ColumnBF12_9.Col4].ToString() == show)
                {
                    F202.InnerText = dt.Rows[100][(int)ColumnBF12_9.Col1].ToString();
                    G202.InnerText = dt.Rows[100][(int)ColumnBF12_9.Col2].ToString();
                    H202.InnerText = dt.Rows[100][(int)ColumnBF12_9.Col3].ToString();
                    html += string.Format(
                        "<tr><td></td><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td></tr>",
        ...
        protected void btnSynthese_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CalculezMaintenantDataAccess.Save(Session["CLIENT_ID"].TransformToInt(), "BF12-9");
        ...
        protected void btnEnregistrer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var data = @"{" +
                 ...
                 "','txtZone864':'" + txtZone864.Text +
                            "','txtZone866':'" + txtZone866.Text +
                            "','txtZone871':'" + txtZone871.Text +
                ...
                if (obj == null)
                {
                    SimulationActeDataAccess.Save(data, txtLibelle.Text, "BF12-9", false, Session["CLIENT_ID"].TransformToInt());
                }
                else
                {
            ...
            try
            {
                ...
                var data = @"{" +
                 ...
                 "','txtZone864':'" + txtZone864.Text +
                    ...
                    "','txtDébours':'" + txtDébours.Text +
                    "','chkUtilisation_du_futur_tarif':'" + hdUtilisation_du_futur_tarif.Value + "'}";
                SimulationActeDataAccess.Save(data, txtLibelleSous.Text, "BF12-9", false, Session["CLIENT_ID"].TransformToInt());
                Page.ClientScript.RegisterStartupScript(GetType(), "toastr_message", @"toastr.success('Cette simulation a été enregistrée avec succès.', 'Notification', {timeOut: 5000});", true);
                //BindSimulationList(0);
                //BindSimulationArchiveList(0);
                Page.ClientScript.RegisterStartupScript(GetType(), "input_form_click", "ShowHide_input_form($('#btnSynthese'));", true);
        ...
        protected void btnSendEmail_Click(object sender, EventArgs e)
        {
            try
            {
                PdfHelper.GeneratePdf("BF12-9", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
        ...
        {
            var filename = PdfHelper.GeneratePdf("BF12-9", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
