...
{
    public partial class BF12_3 : Page
    {
        ...
        {
            const string show = "1";
            lblF102.InnerText = dt.Rows[0][(int)ColumnBF12_3.Col1].ToString();
            lblF103.InnerText = dt.Rows[1][(int)ColumnBF12_3.Col1].ToString();
            lblF104.InnerText = dt.Rows[2][(int)ColumnBF12_3.Col1].ToString();
            lblF106.InnerText = dt.Rows[4][(int)ColumnBF12_3.Col1].ToString();
            div108.Visible = dt.Rows[6][(int)ColumnBF12_3.Col4].ToString() == show;
            lblF108.InnerText = dt.Rows[6][(int)ColumnBF12_3.Col1].ToString();
            //TVA
            H171.InnerText = dt.Rows[69][(int)ColumnBF12_3.Col3].ToString();
            H173.InnerText = dt.Rows[71][(int)ColumnBF12_3.Col3].ToString();
            H175.InnerText = dt.Rows[73][(int)ColumnBF12_3.Col3].ToString();
            H176.InnerText = dt.Rows[74][(int)ColumnBF12_3.Col3].ToString();
            H177.InnerText = dt.Rows[75][(int)ColumnBF12_3.Col3].ToString();
            //Débours
            lblH182.InnerText = dt.Rows[80][(int)ColumnBF12_3.Col3].ToString();
            //Trésor public
            div187.Visible = dt.Rows[85][(int)ColumnBF12_3.Col4].ToString() == show;
            div188.Visible = dt.Rows[86][(int)ColumnBF12_3.Col4].ToString() == show;
            lblF188.InnerText = dt.Rows[86][(int)ColumnBF12_3.Col1].ToString();
            lblG188.InnerText = dt.Rows[86][(int)ColumnBF12_3.Col2].ToString();
            lblH188.InnerText = dt.Rows[86][(int)ColumnBF12_3.Col3].ToString();
            lblF189.Visible = dt.Rows[87][(int)ColumnBF12_3.Col4].ToString() == show;
            lblF189.InnerText = dt.Rows[87][(int)ColumnBF12_3.Col1].ToString();
            div190.Visible = dt.Rows[88][(int)ColumnBF12_3.Col4].ToString() == show;
            ...
            html += dt.Rows[6][(int)ColumnBF12_3.Col4].ToString() == show
            ...
            html += string.Format(
                    ...
                    lblF106.InnerText);
            if (dt.Rows[6][(int)ColumnBF12_3.Col4].ToString() == show)
            {
                html += string.Format(
            ...
            if (dt.Rows[6][(int)ColumnBF12_3.Col4].ToString() == show)
            {
                html += string.Format(
                        ...
                        Request.PhysicalApplicationPath + "tmp\\BF12-3\\chart.png");
            }
            else
            {
                html += string.Format(
            ...
            row127.Visible = dt.Rows[25][(int)ColumnBF12_3.Col4].ToString() == show;
            if (dt.Rows[25][(int)ColumnBF12_3.Col4].ToString() == show)
            {
                ...
                row128.Visible = dt.Rows[26][(int)ColumnBF12_3.Col4].ToString() == show;
                if (dt.Rows[26][(int)ColumnBF12_3.Col4].ToString() == show)
                {
                    F128.InnerText = dt.Rows[26][(int)ColumnBF12_3.Col1].ToString();
                    G128.InnerText = dt.Rows[26][(int)ColumnBF12_3.Col2].ToString();
                    H128.InnerText = dt.Rows[26][(int)ColumnBF12_3.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F128.InnerText, G128.InnerText, H128.InnerText);
                }
                row129.Visible = dt.Rows[27][(int)ColumnBF12_3.Col4].ToString() == show;
                if (dt.Rows[27][(int)ColumnBF12_3.Col4].ToString() == show)
                {
                    F129.InnerText = dt.Rows[27][(int)ColumnBF12_3.Col1].ToString();
                    G129.InnerText = dt.Rows[27][(int)ColumnBF12_3.Col2].ToString();
                    H129.InnerText = dt.Rows[27][(int)ColumnBF12_3.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F129.InnerText, G129.InnerText, H129.InnerText);
                }
                row130.Visible = dt.Rows[28][(int)ColumnBF12_3.Col4].ToString() == show;
                if (dt.Rows[28][(int)ColumnBF12_3.Col4].ToString() == show)
                {
                    F130.InnerText = dt.Rows[28][(int)ColumnBF12_3.Col1].ToString();
                    G130.InnerText = dt.Rows[28][(int)ColumnBF12_3.Col2].ToString();
                    H130.InnerText = dt.Rows[28][(int)ColumnBF12_3.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F130.InnerText, G130.InnerText, H130.InnerText);
                }
                row131.Visible = dt.Rows[29][(int)ColumnBF12_3.Col4].ToString() == show;
                if (dt.Rows[29][(int)ColumnBF12_3.Col4].ToString() == show)
                {
                    F131.InnerText = dt.Rows[29][(int)ColumnBF12_3.Col1].ToString();
                    G131.InnerText = dt.Rows[29][(int)ColumnBF12_3.Col2].ToString();
                    H131.InnerText = dt.Rows[29][(int)ColumnBF12_3.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F131.InnerText, G131.InnerText, H131.InnerText);
                }
                row133.Visible = dt.Rows[31][(int)ColumnBF12_3.Col4].ToString() == show;
                if (dt.Rows[31][(int)ColumnBF12_3.Col4].ToString() == show)
                {
                    G133.InnerText = dt.Rows[31][(int)ColumnBF12_3.Col2].ToString();
                    html += string.Format(
                        "<tr><td align='right'>Total :</td><td align='right'>{0}</td><td colspan='2'></td></tr>",
                        G133.InnerText);
                }
                row134.Visible = dt.Rows[32][(int)ColumnBF12_3.Col4].ToString() == show;
                if (dt.Rows[32][(int)ColumnBF12_3.Col4].ToString() == show)
                {
                    H134.InnerText = dt.Rows[32][(int)ColumnBF12_3.Col3].ToString();
                    html += string.Format(
                        "<tr><td colspan='2' align='right'>TOTAL Hors T.V.A :</td><td align='right'>{0}</td><td></td></tr>",
                        H134.InnerText);
                }
                row136.Visible = dt.Rows[34][(int)ColumnBF12_3.Col4].ToString() == show;
                if (dt.Rows[34][(int)ColumnBF12_3.Col4].ToString() == show)
                {
                    H136.InnerText = dt.Rows[34][(int)ColumnBF12_3.Col3].ToString();
                    html += string.Format(
            ...
            html += "<tr><td colspan='4' bgcolor='#01ABE4'></td></tr>";
            if (dt.Rows[85][(int)ColumnBF12_3.Col4].ToString() == show)
            {
                if (dt.Rows[86][(int)ColumnBF12_3.Col4].ToString() == show)
                {
                    html += string.Format(
                ...
                if (dt.Rows[87][(int)ColumnBF12_3.Col4].ToString() == show)
                {
                    html += string.Format("<tr><td colspan='4' align='center'>{0}</td></tr>", lblF189.InnerText);
                }
                if (dt.Rows[88][(int)ColumnBF12_3.Col4].ToString() == show)
                {
                    html += "<tr><td colspan='4' align='center'>Pour la TPF, il a été pris le minimum de perception soit 25 Euros.</td></tr>";
                }
            }
            row192.Visible = dt.Rows[90][(int)ColumnBF12_3.Col4].ToString() == show;
            if (dt.Rows[90][(int)ColumnBF12_3.Col4].ToString() == show)
            {
                H192.InnerText = dt.Rows[90][(int)ColumnBF12_3.Col3].ToString();
                H193.InnerText = dt.Rows[91][(int)ColumnBF12_3.Col3].ToString();
                html += string.Format(
            ...
            row195.Visible = dt.Rows[93][(int)ColumnBF12_3.Col4].ToString() == show;
            if (dt.Rows[93][(int)ColumnBF12_3.Col4].ToString() == show)
            {
                row196.Visible = dt.Rows[94][(int)ColumnBF12_3.Col4].ToString() == show;
                if (dt.Rows[94][(int)ColumnBF12_3.Col4].ToString() == show)
                {
                    F196.InnerText = dt.Rows[94][(int)ColumnBF12_3.Col1].ToString();
                    G196.InnerText = dt.Rows[94][(int)ColumnBF12_3.Col2].ToString();
                    H196.InnerText = dt.Rows[94][(int)ColumnBF12_3.Col3].ToString();
                    html += string.Format(
                ...
                row197.Visible = dt.Rows[95][(int)ColumnBF12_3.Col4].ToString() == show;
                if (dt.Rows[95][(int)ColumnBF12_3.Col4].ToString() == show)
                {
            ...
            row199.Visible = dt.Rows[97][(int)ColumnBF12_3.Col4].ToString() == show;
            if (dt.Rows[97][(int)ColumnBF12_3.Col4].ToString() == show)
            {
                html += "<tr><td colspan='4' align='left'>Droit de mutation sur le prix de cession :</td></tr>";
                row200.Visible = dt.Rows[98][(int)ColumnBF12_3.Col4].ToString() == show;
                if (dt.Rows[98][(int)ColumnBF12_3.Col4].ToString() == show)
                {
                    F200.InnerText = dt.Rows[98][(int)ColumnBF12_3.Col1].ToString();
                    G200.InnerText = dt.Rows[98][(int)ColumnBF12_3.Col2].ToString();
                    H200.InnerText = dt.Rows[98][(int)ColumnBF12_3.Col3].ToString();
                    html += string.Format(
                        "<tr><td></td><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td></tr>",
                        F200.InnerText, G200.InnerText, H200.InnerText);
                }
                row201.Visible = dt.Rows[99][(int)ColumnBF12_3.Col4].ToString() == show;
                if (dt.Rows[99][(int)ColumnBF12_3.Col4].ToString() == show)
                {
                    F201.InnerText = dt.Rows[99][(int)ColumnBF12_3.Col1].ToString();
                    G201.InnerText = dt.Rows[99][(int)ColumnBF12_3.Col2].ToString();
                    H201.InnerText = dt.Rows[99][(int)ColumnBF12_3.Col3].ToString();
                    html += string.Format(
                        "<tr><td></td><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td></tr>",
                        F201.InnerText, G201.InnerText, H201.InnerText);
                }
                row202.Visible = dt.Rows[100][(int)ColumnBF12_3.Col4].ToString() == show;
                if (dt.Rows[100][(int)ColumnBF12_3.Col4].ToString() == show)
                {
                    F202.InnerText = dt.Rows[100][(int)ColumnBF12_3.Col1].ToString();
                    G202.InnerText = dt.Rows[100][(int)ColumnBF12_3.Col2].ToString();
                    H202.InnerText = dt.Rows[100][(int)ColumnBF12_3.Col3].ToString();
                    html += string.Format(
                        "<tr><td></td><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td></tr>",
        ...
        protected void btnSynthese_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CalculezMaintenantDataAccess.Save(Session["CLIENT_ID"].TransformToInt(), "BF12-3");
        ...
        protected void btnEnregistrer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (obj == null)
                {
                    SimulationActeDataAccess.Save(data, txtLibelle.Text, "BF12-3", false, Session["CLIENT_ID"].TransformToInt());
                }
                else
                {
        ...
        protected void btnEnregistrerSous_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var data = @"{" +
                    ...
                    "','txtDébours':'" + txtDébours.Text +
                    "','chkUtilisation_du_futur_tarif':'" + hdUtilisation_du_futur_tarif.Value + "'}";
                SimulationActeDataAccess.Save(data, txtLibelleSous.Text, "BF12-3", false, Session["CLIENT_ID"].TransformToInt());
                Page.ClientScript.RegisterStartupScript(GetType(), "toastr_message", @"toastr.success('Cette simulation a été enregistrée avec succès.', 'Notification', {timeOut: 5000});", true);
                //BindSimulationList(0);
                //BindSimulationArchiveList(0);
                Page.ClientScript.RegisterStartupScript(GetType(), "input_form_click", "ShowHide_input_form($('#btnSynthese'));", true);
        ...
        protected void btnSendEmail_Click(object sender, EventArgs e)
        {
            try
            {
                PdfHelper.GeneratePdf("BF12-3", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
        ...
        {
            var filename = PdfHelper.GeneratePdf("BF12-3", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
