<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="SUCC-DROITS.aspx.cs" Inherits="NotaliaOnline.SUCC_DROITS" ValidateRequest="false" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="card-body">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-6 col-12">
                                <asp:DropDownList CssClass="select2" runat="server" ClientIDMode="Static" ID="ddl1">
                                    ...
                                    <asp:ListItem Value="8">Au profit du conjoint marié</asp:ListItem>
                                    <asp:ListItem Value="9">Au profit du conjoint pacsé</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                ...
                <div class="sub-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                            <label class="col-12 col-sm-4 col-form-label text-left text-sm-right">Base taxable : </label>
                            <div class="col-sm-3 col-12">
        ...
        <div class="card">
            ...
            <div class="card-body text-right">
                <div class="sub-card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <label class="col-6 col-sm-6">Montant hérité :</label>
                            <label class="col-6 col-sm-3" runat="server" clientidmode="Static" id="G10"></label>
                        </div>
                        <div runat="server" id="row12">
                            <div class="row">
                                <label class="col-6 col-sm-6">Abattement général :</label>
                                <label class="col-6 col-sm-3" runat="server" clientidmode="Static" id="G12"></label>
                            </div>
                        </div>
                        ...
                        <div runat="server" id="row17">
                            <div class="row">
                                <label class="col-6 col-sm-6">Abattement pour infirmité :</label>
                                <label class="col-6 col-sm-3" runat="server" clientidmode="Static" id="G17"></label>
                            </div>
                            <div runat="server" id="row19">
                                <div class="row">
                                    <label class="col-12 col-sm-9">Abattemet pour infirmité déjà utilisé :</label>
                        ...
                        <div class="row">
                            <label class="col-6 col-sm-6">Base taxable : </label>
                            <label class="col-6 col-sm-3" runat="server" clientidmode="Static" id="G22"></label>
                        </div>
                    </div>
                </div>
                <div class="sub-card" runat="server" id="case1">
                    <div class="card-header">
                        Détermination des droits à payer
                    </div>
                    <div class="card-body">
                ...
                <div class="sub-card" runat="server" id="case2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row text-center" runat="server" id="row213">
                ...
                <div class="sub-card" runat="server" id="case9">
                    <div class="card-header">
                        Détermination des droits à payer
                    </div>
                    <div class="card-body">
                        <div class="row" runat="server" id="row900">
                            <label class="col-4 col-sm-3" runat="server" clientidmode="Static" id="F900"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G900"></label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H900"></label>
                        </div>
                        <div class="row" runat="server" id="row901">
                            <label class="col-4 col-sm-3" runat="server" clientidmode="Static" id="F901"></label>
                            <label class="col-8 col-sm-9 text-center" runat="server" clientidmode="Static" id="G901"></label>
                        </div>
                        <div class="row " runat="server" id="row902">
                            <label class="col-4 col-sm-3" runat="server" clientidmode="Static" id="F902"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G902"></label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H902"></label>
                        </div>
                        <div class="row" runat="server" id="row903">
                            <label class="col-4 col-sm-3" runat="server" clientidmode="Static" id="F903"></label>
                            <label class="col-8 col-sm-9 text-center" runat="server" clientidmode="Static" id="G903"></label>
                        </div>
                        <div class="row " runat="server" id="row904">
                            <label class="col-4 col-sm-3" runat="server" clientidmode="Static" id="F904"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G904"></label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H904"></label>
                        </div>
                        <div class="row" runat="server" id="row905">
                            <label class="col-4 col-sm-3" runat="server" clientidmode="Static" id="F905"></label>
                            <label class="col-8 col-sm-9 text-center" runat="server" clientidmode="Static" id="G905"></label>
                        </div>
                        <div class="row " runat="server" id="row906">
                            <label class="col-4 col-sm-3" runat="server" clientidmode="Static" id="F906"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G906"></label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H906"></label>
                        </div>
                        <div class="row" runat="server" id="row907">
                            <label class="col-4 col-sm-3" runat="server" clientidmode="Static" id="F907"></label>
                            <label class="col-8 col-sm-9 text-center" runat="server" clientidmode="Static" id="G907"></label>
                        </div>
                        <div class="row " runat="server" id="row908">
                            <label class="col-4 col-sm-3" runat="server" clientidmode="Static" id="F908"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G908"></label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H908"></label>
                        </div>
                        <div class="row" runat="server" id="row909">
                            <label class="col-4 col-sm-3" runat="server" clientidmode="Static" id="F909"></label>
                            <label class="col-8 col-sm-9 text-center" runat="server" clientidmode="Static" id="G909"></label>
                        </div>
                        <div class="row " runat="server" id="row910">
                            <label class="col-4 col-sm-3" runat="server" clientidmode="Static" id="F910"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G910"></label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H910"></label>
                        </div>
                        <div class="row" runat="server" id="row911">
                            <label class="col-4 col-sm-3" runat="server" clientidmode="Static" id="F911"></label>
                            <label class="col-8 col-sm-9 text-center" runat="server" clientidmode="Static" id="G911"></label>
                        </div>
                        <div class="row " runat="server" id="row912">
                            <label class="col-4 col-sm-3" runat="server" clientidmode="Static" id="F912"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G912"></label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H912"></label>
                        </div>
                        <div class="row" runat="server" id="row913">
                            <label class="col-4 col-sm-3" runat="server" clientidmode="Static" id="F913"></label>
                            <label class="col-8 col-sm-9 text-center" runat="server" clientidmode="Static" id="G913"></label>
                        </div>
                        <div class="row" runat="server" id="row914">
                            <label class="col-12 col-sm-4">Total :</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G914" style="font-size: 1.2em"></label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H914" style="font-size: 1.2em"></label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="Scripts/SUCC-DROITS.js"></script>
</asp:Content>
