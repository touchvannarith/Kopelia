<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="BF02-13.aspx.cs" Inherits="NotaliaOnline.BF02_13" ValidateRequest="false" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="card-body">
                <div class="row form-group">
                    ...
                    <div class="col-12 col-sm-6 col-sm-offset-4">
                        <asp:RadioButton runat="server" ClientIDMode="Static" GroupName="Procuration" ID="radProcuration1"
                            CssClass="checkbox-custom procuration" Text="S'agit-il d'une procuration en minute?" Checked="True" />
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-12 col-sm-4 col-form-label text-left text-sm-right"></label>
                    <div class="col-12 col-sm-6 col-sm-offset-4">
                        <asp:RadioButton runat="server" ClientIDMode="Static" GroupName="Procuration" ID="radProcuration2"
                            CssClass="checkbox-custom procuration" Text="S'agit-il d'une procuration en brevet?" />
                    </div>
                </div>
                <div class="sub-card">
                    <div class="card-header">
    ...
    <div runat="server" clientidmode="Static" id="divResult">
        <div class="card">
            ...
            <div class="card-body text-right">
                <div class="row">
                    ...
                    <label runat="server" id="D723" clientidmode="Static" class="col-6 col-sm-3"></label>
                </div>
                <div class="row">
                    <label class="col-6 col-sm-6">Débours : </label>
                    <label runat="server" id="D724" clientidmode="Static" class="col-6 col-sm-3"></label>
                </div>
                <div class="row">
                    <label class="col-6 col-sm-6">Trésor public : </label>
                    <label runat="server" id="D725" clientidmode="Static" class="col-6 col-sm-3"></label>
                </div>
                <div class="row fa-2x">
                    <label class="col-6 col-sm-6">Montant des frais : </label>
                    <label runat="server" id="D726" class="col-6 col-sm-3"></label>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="sub-card">
                    <div class="card-header">
                        Emoluments du notaire - C.com. Art. A 444-167
                    </div>
                    <div class="card-body text-right">
                        <div class="row ">
                            ...
                            <div class="col-6 col-sm-3">
                                <label runat="server" id="D705"></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="sub-card">
                    ...
                    <div class="card-body text-right">
                        <div class="row ">
                            ...
                            <div class="col-6 col-sm-3">
                                <label runat="server" id="D709"></label>
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-6 col-sm-9">
                            ...
                            <div class="col-6 col-sm-3">
                                <label runat="server" id="D710"></label>
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-6 col-sm-9">
                            ...
                            <div class="col-6 col-sm-3">
                                <label runat="server" id="D711"></label>
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-6 col-sm-9">
                                <label>TVA :</label></div>
                            <div class="col-6 col-sm-3">
                                <label runat="server" id="D712"></label>
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-6 col-sm-9">
                            ...
                            <div class="col-6 col-sm-3">
                                <label runat="server" id="D713"></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="sub-card">
                    ...
                    <div class="card-body text-right">
                        <div class="row">
                            ...
                            <div class="col-6 col-sm-3">
                                <label runat="server" id="D717"></label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="sub-card">
                    ...
                    <div class="card-body text-right">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-sm-3">
                                <label runat="server" id="D721"></label>
                            </div>
                        </div>
    ...
    <script type="text/javascript" src="Scripts/BF02-13.js"></script>
</asp:Content>
