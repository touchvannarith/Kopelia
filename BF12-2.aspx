<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="BF12-2.aspx.cs" Inherits="NotaliaOnline.BF12_2" ValidateRequest="false" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" clientidmode="Static" id="div_input_form_1">
        <div class="card">
            <div class="card-header">
                ...
                Partage de biens de communauté consécutif à divorce (art 746 CGI)
            </div>
                ...
                <div class="sub-card">
                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            ...
                            <asp:CheckBox runat="server" ClientIDMode="Static" ID="chk76" CssClass="checkbox-custom col-sm-8 col-12"
                                Text="Notaire commis en cas de divorce (C. civ., art.255, 10°) ?" />
                        </div>
                        <div class="row form-group">
                            <label class="col-12 col-sm-4 col-form-label text-left text-sm-right"></label>
                            <asp:CheckBox runat="server" ClientIDMode="Static" ID="chk78" CssClass="checkbox-custom col-sm-8 col-12"
                                Text="Application de l'aide juridictionnelle ?" />
                        </div>
                    </div>
                </div>
                <div class="sub-card">
    ...
    <div runat="server" clientidmode="Static" id="divResult">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="sub-card" runat="server" id="row113">
                    <div class="card-header">
                        <label>Emoluments du notaire - C.com. Art. A 444-121</label>
                    </div>
                    <div class="card-body text-right">
                        ...
                        <div class="row" runat="server" id="div116">
                            <label runat="server" class="col-4 col-sm-3" id="lblF116"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label runat="server" class="col-6 col-sm-3" id="lblG116"></label>
                            <label class="col-2 col-offset-4 col-sm-2 col-sm-offset-0">=</label>
                            <label runat="server" class="col-6 col-sm-3" id="lblH116"></label>
                        </div>
                        <div class="row" runat="server" id="div117">
                            <label runat="server" class="col-4 col-sm-3" id="lblF117"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label runat="server" class="col-6 col-sm-3" id="lblG117"></label>
                            <label class="col-2 col-offset-4 col-sm-2 col-sm-offset-0">=</label>
                            <label runat="server" class="col-6 col-sm-3" id="lblH117"></label>
                        </div>
                        <div class="row" runat="server" id="div119">
                            <label class="col-6 col-sm-4">Total :</label>
                            <label runat="server" id="lblG119" class="col-6 col-sm-3"></label>
                        </div>
                        ...
                        <div class="row" runat="server" id="div122">
                            <label class="col-6 col-sm-9">Emolument minimum :</label>
                            <label runat="server" id="lblH122" class="col-6 col-sm-3"></label>
                        </div>
                    </div>
                </div>
                <div class="sub-card">
    ...
    <script type="text/javascript" src="Scripts/BF12-2.js"></script>
</asp:Content>
