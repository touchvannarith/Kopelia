<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="BF12-2b.aspx.cs" Inherits="NotaliaOnline.BF12_2b" ValidateRequest="false" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" clientidmode="Static" id="div_input_form_1">
        <div class="card">
            <div class="card-header">
                ...
                Partage de biens indivis consécutif à divorce ou rupture de PACS (art 746 CGI)
            </div>
    ...
    <script type="text/javascript" src="Scripts/BF12-2b.js"></script>
</asp:Content>
