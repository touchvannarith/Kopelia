<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="DON02.aspx.cs" Inherits="NotaliaOnline.DON02" ValidateRequest="false" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" clientidmode="Static" id="div_input_form_1">
        <div class="card">
            <div class="card-header">
                ...
                Donation et donation partage (2 donateurs)
            </div>
            ...
            <div class="card-body">
                <div class="sub-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                            <label class="col-12 col-sm-4 col-form-label text-left text-sm-right">Date de naissance du donateur 1 :</label>
                            <div class="col-sm-3 col-12">
                                <asp:TextBox CssClass="form-control control-input" runat="server" ClientIDMode="Static" ID="txtZone02"></asp:TextBox>
                                <i class="form-control-feedback fa fa-calendar"></i>
                            </div>
                        </div>
                        <div class="row form-group">
                            <label class="col-12 col-sm-4 col-form-label text-left text-sm-right">Date de naissance du donateur 2 :</label>
                            <div class="col-sm-3 col-12">
                                <asp:TextBox CssClass="form-control control-input" runat="server" ClientIDMode="Static" ID="txtZone03"></asp:TextBox>
                                <i class="form-control-feedback fa fa-calendar"></i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="sub-card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="divArticle1">
                            <div class="row form-group">
                                <label class="control-label col-sm-2 ">Article 1</label>
                                <label class="col-sm-2 col-form-label text-left text-sm-right">Origine :</label>
                                <div class="col-sm-3">
                                    <asp:DropDownList CssClass="select2" runat="server" ClientIDMode="Static" ID="ddlOrigine1">
                                        <asp:ListItem Value="1">Donateur 1</asp:ListItem>
                                        <asp:ListItem Value="2" Selected="True">Commun</asp:ListItem>
                                        <asp:ListItem Value="3">Donateur 2</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            ...
                            <div class="row form-group">
                                <label class="col-sm-4 col-form-label text-left text-sm-right"></label>
                                <div class="col-sm-3 col-12">
                                    <asp:CheckBox runat="server" ClientIDMode="Static" ID="chkArticle1" CssClass="checkbox"
                        ...
                        <div id="divArticle2">
                            <div class="row form-group">
                                <label class="control-label col-sm-2 ">Article 2</label>
                                <label class="col-sm-2 col-form-label text-left text-sm-right">Origine :</label>
                                <div class="col-sm-3">
                                    <asp:DropDownList CssClass="select2" runat="server" ClientIDMode="Static" ID="ddlOrigine2">
                                        <asp:ListItem Value="1">Donateur 1</asp:ListItem>
                                        <asp:ListItem Value="2" Selected="True">Commun</asp:ListItem>
                                        <asp:ListItem Value="3">Donateur 2</asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <div class="row form-group">
                                <label class="col-sm-4 col-form-label text-left text-sm-right"></label>
                                <div class="col-sm-3 col-12">
                                <asp:CheckBox runat="server" ClientIDMode="Static" ID="chkArticle2" CssClass="checkbox"
                                    Text="Réserve d'usufruit" />
                                    </div>
                                <label class="col-sm-2 col-12 col-form-label text-left text-sm-right">Valeur PP :</label>
                                <div class="col-sm-3 col-12">
                        ...
                        <div id="divArticle3">
                            <div class="row form-group">
                                <label class="control-label col-sm-2 ">Article 3</label>
                                <label class="col-sm-2 col-form-label text-left text-sm-right">Origine :</label>
                                <div class="col-sm-3">
                                    <asp:DropDownList CssClass="select2" runat="server" ClientIDMode="Static" ID="ddlOrigine3">
                                        <asp:ListItem Value="1">Donateur 1</asp:ListItem>
                                        <asp:ListItem Value="2" Selected="True">Commun</asp:ListItem>
                                        <asp:ListItem Value="3">Donateur 2</asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <div class="row form-group">
                                <label class="col-sm-4 col-form-label text-left text-sm-right"></label>
                                <div class="col-sm-3 col-12">
                                <asp:CheckBox runat="server" ClientIDMode="Static" ID="chkArticle3" CssClass="checkbox"
                                    Text="Réserve d'usufruit" />
                                 </div>
                                <label class="col-sm-2 col-12 col-form-label text-left text-sm-right">Valeur PP :</label>
                                <div class="col-sm-3 col-12">
                        ...
                        <div id="divArticle4">
                            <div class="row form-group">
                                <label class="control-label col-sm-2 ">Article 4</label>
                                <label class="col-sm-2 col-form-label text-left text-sm-right">Origine :</label>
                                <div class="col-sm-3">
                                    <asp:DropDownList CssClass="select2" runat="server" ClientIDMode="Static" ID="ddlOrigine4">
                                        <asp:ListItem Value="1">Donateur 1</asp:ListItem>
                                        <asp:ListItem Value="2" Selected="True">Commun</asp:ListItem>
                                        <asp:ListItem Value="3">Donateur 2</asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <div class="row form-group">
                                <label class="col-sm-4 col-form-label text-left text-sm-right"></label>
                                <div class="col-sm-3 col-12">
                                <asp:CheckBox runat="server" ClientIDMode="Static" ID="chkArticle4" CssClass="checkbox"
                                    Text="Réserve d'usufruit" />
                                    </div>
                                <label class="col-sm-2 col-12 col-form-label text-left text-sm-right">Valeur PP :</label>
                                <div class="col-sm-3 col-12">
                        ...
                        <div id="divArticle5">
                            <div class="row form-group">
                                <label class="control-label col-sm-2 ">Article 5</label>
                                <label class="col-sm-2 col-form-label text-left text-sm-right">Origine :</label>
                                <div class="col-sm-3">
                                    <asp:DropDownList CssClass="select2" runat="server" ClientIDMode="Static" ID="ddlOrigine5">
                                        <asp:ListItem Value="1">Donateur 1</asp:ListItem>
                                        <asp:ListItem Value="2" Selected="True">Commun</asp:ListItem>
                                        <asp:ListItem Value="3">Donateur 2</asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <div class="row form-group">
                                <label class="col-sm-4 col-form-label text-left text-sm-right"></label>
                                <div class="col-sm-3 col-12">
                                <asp:CheckBox runat="server" ClientIDMode="Static" ID="chkArticle5" CssClass="checkbox"
                                    Text="Réserve d'usufruit" />
                                    </div>
                                <label class="col-sm-2 col-12 col-form-label text-left text-sm-right">Valeur PP :</label>
                                <div class="col-sm-3 col-12">
                        ...
                        <div id="divArticle6">
                            <div class="row form-group">
                                <label class="control-label col-sm-2 ">Article 6</label>
                                <label class="col-sm-2 col-form-label text-left text-sm-right">Origine :</label>
                                <div class="col-sm-3">
                                    <asp:DropDownList CssClass="select2" runat="server" ClientIDMode="Static" ID="ddlOrigine6">
                                        <asp:ListItem Value="1">Donateur 1</asp:ListItem>
                                        <asp:ListItem Value="2" Selected="True">Commun</asp:ListItem>
                                        <asp:ListItem Value="3">Donateur 2</asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <div class="row form-group">
                                <label class="col-sm-4 col-form-label text-left text-sm-right"></label>
                                <div class="col-sm-3 col-12">
                                <asp:CheckBox runat="server" ClientIDMode="Static" ID="chkArticle6" CssClass="checkbox"
                                    Text="Réserve d'usufruit" />
                                    </div>
                                <label class="col-sm-2 col-12 col-form-label text-left text-sm-right">Valeur PP :</label>
                                <div class="col-sm-3 col-12">
                        ...
                        <div id="divArticle7">
                            <div class="row form-group">
                                <label class="control-label col-sm-2 ">Article 7</label>
                                <label class="col-sm-2 col-form-label text-left text-sm-right">Origine :</label>
                                <div class="col-sm-3">
                                    <asp:DropDownList CssClass="select2" runat="server" ClientIDMode="Static" ID="ddlOrigine7">
                                        <asp:ListItem Value="1">Donateur 1</asp:ListItem>
                                        <asp:ListItem Value="2" Selected="True">Commun</asp:ListItem>
                                        <asp:ListItem Value="3">Donateur 2</asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <div class="row form-group">
                                <label class="col-sm-4 col-form-label text-left text-sm-right"></label>
                                <div class="col-sm-3 col-12">
                                <asp:CheckBox runat="server" ClientIDMode="Static" ID="chkArticle7" CssClass="checkbox"
                                    Text="Réserve d'usufruit" />
                                    </div>
                                <label class="col-sm-2 col-12 col-form-label text-left text-sm-right">Valeur PP :</label>
                                <div class="col-sm-3 col-12">
                        ...
                        <div id="divArticle8">
                            <div class="row form-group">
                                <label class="control-label col-sm-2 ">Article 8</label>
                                <label class="col-sm-2 col-form-label text-left text-sm-right">Origine :</label>
                                <div class="col-sm-3">
                                    <asp:DropDownList CssClass="select2" runat="server" ClientIDMode="Static" ID="ddlOrigine8">
                                        <asp:ListItem Value="1">Donateur 1</asp:ListItem>
                                        <asp:ListItem Value="2" Selected="True">Commun</asp:ListItem>
                                        <asp:ListItem Value="3">Donateur 2</asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <div class="row form-group">
                                <label class="col-sm-4 col-form-label text-left text-sm-right"></label>
                                <div class="col-sm-3 col-12">
                                <asp:CheckBox runat="server" ClientIDMode="Static" ID="chkArticle8" CssClass="checkbox"
                                    Text="Réserve d'usufruit" />
                                    </div>
                                <label class="col-sm-2 col-12 col-form-label text-left text-sm-right">Valeur PP :</label>
                                <div class="col-sm-3 col-12">
                        ...
                        <div id="divArticle9">
                            <div class="row form-group">
                                <label class="control-label col-sm-2 ">Article 9</label>
                                <label class="col-sm-2 col-form-label text-left text-sm-right">Origine :</label>
                                <div class="col-sm-3">
                                    <asp:DropDownList CssClass="select2" runat="server" ClientIDMode="Static" ID="ddlOrigine9">
                                        <asp:ListItem Value="1">Donateur 1</asp:ListItem>
                                        <asp:ListItem Value="2" Selected="True">Commun</asp:ListItem>
                                        <asp:ListItem Value="3">Donateur 2</asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <div class="row form-group">
                                <label class="col-sm-4 col-form-label text-left text-sm-right"></label>
                                <div class="col-sm-3 col-12">
                                <asp:CheckBox runat="server" ClientIDMode="Static" ID="chkArticle9" CssClass="checkbox"
                                    Text="Réserve d'usufruit" />
                                    </div>
                                <label class="col-sm-2 col-12 col-form-label text-left text-sm-right">Valeur PP :</label>
                                <div class="col-sm-3 col-12">
                        ...
                        <div id="divArticle10">
                            <div class="row form-group">
                                <label class="control-label col-sm-2 ">Article 10</label>
                                <label class="col-sm-2 col-form-label text-left text-sm-right">Origine :</label>
                                <div class="col-sm-3">
                                    <asp:DropDownList CssClass="select2" runat="server" ClientIDMode="Static" ID="ddlOrigine10">
                                        <asp:ListItem Value="1">Donateur 1</asp:ListItem>
                                        <asp:ListItem Value="2" Selected="True">Commun</asp:ListItem>
                                        <asp:ListItem Value="3">Donateur 2</asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <div class="row form-group">
                                <label class="col-sm-4 col-form-label text-left text-sm-right"></label>
                                <div class="col-sm-3 col-12">
                                <asp:CheckBox runat="server" ClientIDMode="Static" ID="chkArticle10" CssClass="checkbox"
                                    Text="Réserve d'usufruit" />
                                    </div>
                                <label class="col-sm-2 col-12 col-form-label text-left text-sm-right">Valeur PP :</label>
                                <div class="col-sm-3 col-12">
                ...
                <div class="sub-card">
                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 col-12">
                                <asp:TextBox runat="server" ClientIDMode="Static" ID="txtEmolument_de_formalités_HT" CssClass="form-control numberFormatFR" value="400"></asp:TextBox>
                                <i class="form-control-feedback fa fa-euro"></i>
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 col-12">
                                <asp:TextBox runat="server" ClientIDMode="Static" ID="txtDébours" CssClass="form-control numberFormatFR" value="200"></asp:TextBox>
                                <i class="form-control-feedback fa fa-euro"></i>
                            </div>
                        </div>
                    </div>
    ...
    <div runat="server" clientidmode="Static" id="divResult">
        ...
        <div class="card">
            ...
            <div class="card-body text-right">
                ...
                <div class="sub-card" runat="server" id="row122">
                    <div class="card-header">
                        Emoluments du notaire - C.com. Art. A 444-67
                    </div>
                    <div class="card-body">
                        <div class="row" runat="server" id="row123">
                            <label class="col-4 col-sm-2" runat="server" clientidmode="Static" id="F123"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G123"></label>
                            <label class="col-6 col-sm-1">=</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H123"></label>
                        </div>
                        <div class="row" runat="server" id="row124">
                            <label class="col-4 col-sm-2" runat="server" clientidmode="Static" id="F124"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G124"></label>
                            <label class="col-6 col-sm-1">=</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H124"></label>
                        </div>
                        <div class="row" runat="server" id="row125">
                            <label class="col-4 col-sm-2" runat="server" clientidmode="Static" id="F125"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G125"></label>
                            <label class="col-6 col-sm-1">=</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H125"></label>
                        </div>
                        <div class="row" runat="server" id="row126">
                            <label class="col-4 col-sm-2" runat="server" clientidmode="Static" id="F126"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G126"></label>
                            <label class="col-6 col-sm-1">=</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H126"></label>
                        </div>
                        <div class="row" runat="server" id="row128">
                            <label class="col-6 col-sm-3">Total :</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G128"></label>
                        </div>
                ...
                <div class="sub-card">
                    ...
                    <div class="card-body">
                        <div class="row" runat="server" id="row134">
                            <label class="col-6 col-sm-8">Total HT des émoluments du Notaire pour le donateur 1 :</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H134"></label>
                        </div>
                        <div class="row" runat="server" id="row135">
                            <label class="col-6 col-sm-8">Total HT des émoluments du Notaire pour le donateur 2 :</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H135"></label>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <label class="col-6 col-sm-8">Total HT des émoluments :</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H137"></label>
                        </div>
                        <div class="row">
                ...
                <div class="sub-card">
                    ...
                    <div class="card-body">
                        ...
                        <div runat="server" id="row152">
                            <div class="row text-center">
                                <label class="col-12 fa-2x">Donateur 1 :</label>
                            </div>
                            <div class="row">
                        ...
                        <div runat="server" id="row157">
                            <div class="row text-center">
                                <label class="col-12 fa-2x">Donateur 2 :</label>
                            </div>
                            <div class="row">
                                <label class="col-6 col-sm-8">Rappel de la valeur en PP des biens immobiliers :</label>
                                <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H158"></label>
                            </div>
                            <div runat="server" id="row159">
                                <div class="row">
                                    <label class="col-6 col-sm-8">Déduction de la valeur de l'usufruit des biens immobiliers :</label>
                                ...
                                <div class="row">
                                    <label class="col-6 col-sm-8">Base taxable immobilier :</label>
                                    <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H160"></label>
                                </div>
                            </div>
                        </div>
                        <div class="row text-left">
                        ...
                        <div class="row" runat="server" id="row163">
                            <label class="col-4 col-sm-2" runat="server" clientidmode="Static" id="F163"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G163"></label>
                            <label class="col-6 col-sm-1">=</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H163"></label>
                        </div>
                        <div class="row text-center" runat="server" id="row164">
                        ...
                        <div class="row" runat="server" id="row167">
                            <label class="col-4 col-sm-2" runat="server" clientidmode="Static" id="F167"></label>
                            <label class="col-2 col-sm-1">sur</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="G167"></label>
                            <label class="col-6 col-sm-1">=</label>
                            <label class="col-6 col-sm-4" runat="server" clientidmode="Static" id="H167"></label>
                        </div>
                        <div class="row text-center" runat="server" id="row168">
    ...
    <script type="text/javascript" src="Scripts/DON02.js"></script>
</asp:Content>
