<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="BF12-12.aspx.cs" Inherits="NotaliaOnline.BF12_12" ValidateRequest="false" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" clientidmode="Static" id="div_input_form_1">
        <div class="card">
            <div class="card-header">
                ...
                Cession de droit indivis - Droit commun
            </div>
                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 col-12">
                                <asp:TextBox runat="server" ClientIDMode="Static" ID="txtZone832" CssClass="form-control control-input numberFormatFR"></asp:TextBox>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 col-12">
                                <asp:TextBox runat="server" ClientIDMode="Static" ID="txtZone834" CssClass="form-control control-input numberFormatFR"></asp:TextBox>
                                <i class="form-control-feedback fa fa-euro"></i>
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3 col-12">
                                <asp:TextBox runat="server" ClientIDMode="Static" ID="txtZone836" CssClass="form-control control-input numberFormatFR" Enabled="False"></asp:TextBox>
                                <i class="form-control-feedback fa fa-euro"></i>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript" src="Scripts/BF12-12.js"></script>
</asp:Content>
