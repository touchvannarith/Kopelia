...
{
    public partial class BF12_7 : Page
    {
        ...
        private bool FillValues(int id, int clientId)
        {
            try
            {
                ...
                txtRedacteur.Text = json["txtRedacteur"].ToString();
                    ...
                    chk822.Checked = json["chk822"].TransformToBoolean();
                    txtZone824.Text = json["txtZone824"].ToString();
        ...
        private void SetRange()
        {
            ...
            _excelService.SetRange(_sessionId, "ENTREE_S",
                new RangeCoordinates { Row = 57, Column = 5, Height = 2, Width = 1 },
                new object[]
                {
                        new object[]{chk822.Checked.TransformToBooleanFr()},
                        new object[]{txtZone824.Text}
                });
            _excelService.SetRange(_sessionId, "ENTREE_S",
        ...
        private void SetValues(DataTable dt)
        {
            ...
            if (dt.Rows[6][(int)ColumnBF12.Col4].ToString() == show)
            {
                html += string.Format(
                        ...
                        Request.PhysicalApplicationPath + "tmp\\BF12-7\\chart.png");
            }
            else
            {
                html += string.Format(
            ...
            row141.Visible = dt.Rows[39][(int)ColumnBF12.Col4].ToString() == show;
            if (dt.Rows[39][(int)ColumnBF12.Col4].ToString() == show)
            {
                ...
                row142.Visible = dt.Rows[40][(int)ColumnBF12.Col4].ToString() == show;
                if (dt.Rows[40][(int)ColumnBF12.Col4].ToString() == show)
                {
                    F142.InnerText = dt.Rows[40][(int)ColumnBF12.Col1].ToString();
                    G142.InnerText = dt.Rows[40][(int)ColumnBF12.Col2].ToString();
                    H142.InnerText = dt.Rows[40][(int)ColumnBF12.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F142.InnerText, G142.InnerText, H142.InnerText);
                }
                row143.Visible = dt.Rows[41][(int)ColumnBF12.Col4].ToString() == show;
                if (dt.Rows[41][(int)ColumnBF12.Col4].ToString() == show)
                {
                    F143.InnerText = dt.Rows[41][(int)ColumnBF12.Col1].ToString();
                    G143.InnerText = dt.Rows[41][(int)ColumnBF12.Col2].ToString();
                    H143.InnerText = dt.Rows[41][(int)ColumnBF12.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F143.InnerText, G143.InnerText, H143.InnerText);
                }
                row144.Visible = dt.Rows[42][(int)ColumnBF12.Col4].ToString() == show;
                if (dt.Rows[42][(int)ColumnBF12.Col4].ToString() == show)
                {
                    F144.InnerText = dt.Rows[42][(int)ColumnBF12.Col1].ToString();
                    G144.InnerText = dt.Rows[42][(int)ColumnBF12.Col2].ToString();
                    H144.InnerText = dt.Rows[42][(int)ColumnBF12.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F144.InnerText, G144.InnerText, H144.InnerText);
                }
                row145.Visible = dt.Rows[43][(int)ColumnBF12.Col4].ToString() == show;
                if (dt.Rows[43][(int)ColumnBF12.Col4].ToString() == show)
                {
                    F145.InnerText = dt.Rows[43][(int)ColumnBF12.Col1].ToString();
                    G145.InnerText = dt.Rows[43][(int)ColumnBF12.Col2].ToString();
                    H145.InnerText = dt.Rows[43][(int)ColumnBF12.Col3].ToString();
                    html += string.Format(
                        "<tr><td align='right'>{0}    sur</td><td align='right'>{1}    =</td><td align='right'>{2}</td><td></td></tr>",
                        F145.InnerText, G145.InnerText, H145.InnerText);
                }
                row147.Visible = dt.Rows[45][(int)ColumnBF12.Col4].ToString() == show;
                if (dt.Rows[45][(int)ColumnBF12.Col4].ToString() == show)
                {
                    G147.InnerText = dt.Rows[45][(int)ColumnBF12.Col2].ToString();
                    html += string.Format(
                        "<tr><td align='right'>Total :</td><td align='right'>{0}</td><td colspan='2'></td></tr>",
                        G147.InnerText);
                }
                row148.Visible = dt.Rows[46][(int)ColumnBF12.Col4].ToString() == show;
                if (dt.Rows[46][(int)ColumnBF12.Col4].ToString() == show)
                {
                    H148.InnerText = dt.Rows[46][(int)ColumnBF12.Col3].ToString();
                    html += string.Format(
                        "<tr><td colspan='2' align='right'>TOTAL Hors T.V.A :</td><td align='right'>{0}</td><td></td></tr>",
                        H148.InnerText);
                }
                row150.Visible = dt.Rows[48][(int)ColumnBF12.Col4].ToString() == show;
                if (dt.Rows[48][(int)ColumnBF12.Col4].ToString() == show)
                {
                    H150.InnerText = dt.Rows[48][(int)ColumnBF12.Col3].ToString();
                    html += string.Format(
        ...
        protected void btnSynthese_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CalculezMaintenantDataAccess.Save(Session["CLIENT_ID"].TransformToInt(), "BF12-7");
        ...
        protected void btnEnregistrer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var data = @"{" +
                     ...
                     "','chk822':'" + chk822.Checked +
                            "','txtZone824':'" + txtZone824.Text +
                    "','chk1':'" + chk1.Checked +
                ...
                if (obj == null)
                {
                    SimulationActeDataAccess.Save(data, txtLibelle.Text, "BF12-7", false, Session["CLIENT_ID"].TransformToInt());
                }
                else
                {
        ...
        protected void btnEnregistrerSous_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var data = @"{" +
                    ...
                    "','chkUtilisation_du_futur_tarif':'" + hdUtilisation_du_futur_tarif.Value;
                data += "'}";
                SimulationActeDataAccess.Save(data, txtLibelleSous.Text, "BF12-7", false, Session["CLIENT_ID"].TransformToInt());
                Page.ClientScript.RegisterStartupScript(GetType(), "toastr_message", @"toastr.success('Cette simulation a été enregistrée avec succès.', 'Notification', {timeOut: 5000});", true);
                //BindSimulationList(0);
                //BindSimulationArchiveList(0);
                Page.ClientScript.RegisterStartupScript(GetType(), "input_form_click", "ShowHide_input_form($('#btnSynthese'));", true);
        ...
        protected void btnSendEmail_Click(object sender, EventArgs e)
        {
            try
            {
                PdfHelper.GeneratePdf("BF12-7", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
        ...
        {
            var filename = PdfHelper.GeneratePdf("BF12-7", hdPiechart.Value, "", 1, hdSaisie.Value, hdResult.Value, out string pdf);
