<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="BF12-1b.aspx.cs" Inherits="NotaliaOnline.BF12_1b" ValidateRequest="false" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" clientidmode="Static" id="div_input_form_1">
        <div class="card">
            <div class="card-header">
                ...
                Partage de biens indivis - indivision familiale (art 748 CGI)
            </div>
    ...
    <script type="text/javascript" src="Scripts/BF12-1b.js"></script>
</asp:Content>
