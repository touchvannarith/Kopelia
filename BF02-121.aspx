<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="BF02-121.aspx.cs" Inherits="NotaliaOnline.BF02_121" ValidateRequest="false" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row form-group">
                    ...
                    <asp:CheckBox type="checkbox" CssClass="checkbox col-12 col-sm-8" runat="server" ID="chkNotoriete" ClientIDMode="Static"
                        Text="L'acte comporte t-il une déclaration d'option (Art.757, 1094-1 du cc)?" />
                </div>
                <div class="row form-group text-center">
                    <div class="col-12">
                        <label id="lblTextRed1" class="text-danger">Cet acte est soumis à convention d'honoraires.</label>
                    </div>
                </div>
                <div class="sub-card">
                    <div class="card-header">
    ...
    <script type="text/javascript" src="Scripts/BF02-121.js"></script>
</asp:Content>
